...
<head lang="zh-cn">
    ...
    <title>518大厅</title>
    <meta name="apple-mobile-web-app-title" content="518大厅" />
    ...
    *:after {
    ...
    .index {
        ...
        height: 100%;
        position: fixed;
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/bg.jpg") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .picture-mask .picture-box .close-more {
        ...
        width: .3264rem;
        height: .3936rem;
        background: url("http://cdn.lfzgame.com/images/index/mask-close.png") no-repeat;
        background-size: 100% 100%;
    ...
    .top {
        ...
        width: 100%;
        height: .5760rem;
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/top_bg.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .top .issue-room-card {
        right: .6768rem;
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/card.png") no-repeat;
        background-size: 100% 100%;
    }

    .top .room-card-record {
        right: 0;
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/more.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .game-list .game-item {
        ...
        height: 2.1840rem;
        display: inline-block;
        margin: 0 .0720rem .1440rem;
    }

    .game-list .game-item.niuniu-bg {
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/bull6.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.goldflower-bg {
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/goldflow.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.niuniuTen-bg {
        background: url("http://cdn.lfzgame.com/images/hongtaohuyu/bull10.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.fillingpit-bg {
        background: url("http://cdn.lfzgame.com/images/wuyibahuyu/fillingPit-bg1.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .game-list .game-item button {
        ...
        height: .4944rem;
        font-size: 0;
        background: url("http://cdn.lfzgame.com/images/index/sure.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .pupop-container .tab {
        font-size: 0;
        text-align: center;
        background: #d6c99a url("http://cdn.lfzgame.com/images/index/tab_bg.jpg") repeat-x left bottom;
        background-size: auto .0912rem;
        -webkit-border-radius: .0576rem .0576rem 0 0;
        -moz-border-radius: .0576rem .0576rem 0 0;
        border-radius: .0576rem .0576rem 0 0;
        display: -webkit-flex;
        display: flex;
        overflow: hidden;
    }
    ...
    .pupop-container .tab span {
        ...
        font-size: .1440rem;
        color: #f9f1e1;
        background: url("http://cdn.lfzgame.com/images/index/tab-a.jpg") no-repeat;
        background-size: 100% 100%;
        -webkit-border-radius: .0576rem .0576rem 0 0;
        -moz-border-radius: .0576rem .0576rem 0 0;
        border-radius: .0576rem .0576rem 0 0;
        margin: .0144rem 0 0 .0144rem;
    }
    ...
    .pupop-container .tab span.on {
        width: .6768rem;
        height: .5616rem;
        background: url("http://cdn.lfzgame.com/images/index/tab-a-on1.png") no-repeat;
        background-size: 100% 100%;
        color: #b46536;
        margin-top: 0;
    }
    ...
    .pupop-container .text {
        ...
        font-size: .1200rem;
        color: #815133;
        background: url("http://cdn.lfzgame.com/images/index/tip-text.png")no-repeat left bottom;
        background-size: 100% auto;
    }
    ...
    .pupop-container .content-box .createRoomBtn {
        ...
        height: .4272rem;
        font-size: 0;
        background: url("http://cdn.lfzgame.com/images/index/sure1.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .pupop-container .content .zhuangType>.flex-cont {
        ...
        -webkit-box-shadow: 0 .0144rem .0144rem#ccc;
        -moz-box-shadow: 0 .0144rem .0144rem#ccc;
        box-shadow: 0 .0144rem .0144rem#ccc;
    }
    ...
    .withGodBoom {
        ...
        position: relative;
        padding: 0;
        background-color: #d3aa8d;
        text-align: center;
        border-radius: 100%;
        -webkit-box-shadow: 0 0 0.0096rem inset;
        -moz-box-shadow: 0 0 0.0096rem inset;
        box-shadow: 0 0 0.0096rem inset;
    }

    .withGod,
    .withGodBoom {
        display: inline-block;
        border: 0.0096rem solid #9a8270;
    }
    ...
    .withGodChecked:after {
        ...
        width: .0960rem;
        height: .0960rem;
        background: url("http://cdn.lfzgame.com/images/index/radio-bg.jpg") no-repeat;
        background-size: 100% 100%;
        border-radius: 100%;
    ...
    .pupop-container .content>.flex-cont.type input:checked:before {
        ...
        width: .1632rem;
        height: .1584rem;
        background: url("http://cdn.lfzgame.com/images/index/checked-bg.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .pupop-container .content>.flex-cont.number .showNumber {
        ...
        width: .0960rem;
        height: .1248rem;
        background: -webkit-gradient(linear, left top, right top, from(#fac24e), to(#e88b39));
        background: -webkit-linear-gradient(left, #fac24e, #e88b39);
        background: -o-linear-gradient(left, #fac24e, #e88b39);
        background: linear-gradient(to right, #fac24e, #e88b39);
    ...
    .pupop-container .content>.flex-cont.number .showNumber i {
        ...
        -moz-border-radius: 100%;
        border-radius: 100%;
        background: url("http://cdn.lfzgame.com/images/index/icon-i.png") no-repeat;
        background-size: 100% 100%;
        -webkit-box-shadow: 0 .0144rem .0144rem#666;
        -moz-box-shadow: 0 .0144rem .0144rem#666;
        box-shadow: 0 .0144rem .0144rem#666;
    }
    ...
    .pupop-container.threeOpens-mask .tab span {
        ...
        margin: 0;
        height: .5664rem;
        background: url("http://cdn.lfzgame.com/images/index/tab01.png") no-repeat;
        background-size: 100% 100%;
        font-size: .1680rem;
        color: #f4e1a8;
    }
    ...
    .pupop-container.threeOpens-mask .tab span.on {
        background: url("http://cdn.lfzgame.com/images/index/tab01-on.png") no-repeat;
        background-size: 100% 100%;
        color: #9b420c;
    }
    ...
    <div class="index">
        <div class="top">
            <div class="user">
                ...
                <div class="user-info">
                    <div class="name"></div>
                    <div class="room-card"><img src="http://cdn.lfzgame.com/images/index/room-card1.png" alt=""><span></span></div>
                </div>
            </div>
        ...
        <div class="game-list">
            ...
            <div class="game-item fillingpit-bg fillingPitcard-bg">
                <button>创建房间</button>
            </div>
            <!--&lt;!&ndash;三公&ndash;&gt;<div class="game-item three-opens-bg"><button>创建房间</button></div>&lt;!&ndash;德州扑克&ndash;&gt;<div class="game-item texas-poker-bg"><button>创建房间</button></div>--></div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont type">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="checkbox" name="niuniu_hand_patterns" value="1"><span>五花牛（5倍）</span></label>
                                    <label>
                                        <input type="checkbox" name="niuniu_hand_patterns" value="2"><span>炸弹牛（6倍）</span></label>
                                    <br>
                                    <label>
                                        <input type="checkbox" name="niuniu_hand_patterns" value="3"><span>五小牛（8倍）</span></label>
                                </div>
                            </div>
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniu_max_matches" value="10" checked><span>10局×1房卡</span></label>
                                    <label>
                                        <input type="radio" name="niuniu_max_matches" value="20"><span>20局×2房卡</span></label>
                                </div>
                            </div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="gold_max_matches" value="10" checked><span>10局×1房卡</span></label>
                                    <label>
                                        <input type="radio" name="gold_max_matches" value="20"><span>20局×2房卡</span></label>
                                </div>
                            </div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            <div class="flex-cont">
                                ...
                                <label>
                                    <input type="radio" name="texasPoker_mang" value="4"><span>4/8</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_mang" value="6"><span>6/12</span></label>
                            </div>
                            <div class="flex-cont">
                                <div class="title-text">局数</div>
                                <label>
                                    <input type="radio" name="texasPoker_jushu" checked value="10"><span>10局×1房卡</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_jushu" value="20"><span>20局×2房卡</span></label>
                            </div>
                            <div class="flex-cont">
                            ...
                            <div class="flex-cont">
                                ...
                                <label>
                                    <input type="radio" name="texasPoker_chip" value="5000"><span>5000</span></label>
                            </div>
                        </div>
                    </div>
                    <div class="text">创建房间，无人参与，半小时后返还房卡</div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont type">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="checkbox" name="niuniuTen_hand_patterns" value="1"><span>五花牛（5倍）</span></label>
                                    <label>
                                        <input type="checkbox" name="niuniuTen_hand_patterns" value="2"><span>炸弹牛（6倍）</span></label>
                                    <br>
                                    <label>
                                        <input type="checkbox" name="niuniuTen_hand_patterns" value="3"><span>五小牛（8倍）</span></label>
                                </div>
                            </div>
                            <div class="flex-cont innings">
                                <div class="name">局数:</div>
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuTen_max_matches" value="12" checked><span>12局×2房卡</span></label>
                                    <label>
                                        <input type="radio" name="niuniuTen_max_matches" value="24"><span>24局×4房卡</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="thirteen_max_matches" value="5" checked><span>5局×1房卡</span></label>
                                    <label>
                                        <input type="radio" name="thirteen_max_matches" value="10"><span>10局×2房卡</span></label>
                                    <label>
                                        <input type="radio" name="thirteen_max_matches" value="20"><span>20局×4房卡</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont type">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="checkbox" name="threeOpens_hand_patterns" value="2"><span>暴玖×9</span></label>
                                </div>
                            </div>
                            <div class="flex-cont matches">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="threeOpens_max_matches" value="12" checked><span>12局×2房卡</span></label>
                                    <label>
                                        <input type="radio" name="threeOpens_max_matches" value="24"><span>24局×4房卡</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
...
var Page = {
    ...
    moreFunc: function() { var code = '<div class="more-mask2"><div class="content-mask"><div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i><div class="content-item"><div class="item user-friend">好友管理</div></div><div class="content-item"><div class="item user-update">更新资料</div></div><div class="content-item"><div class="item more-room-card">房卡记录</div></div><div class="content-item last"><div class="item log-out">注销登录</div></div><!--<div class="content-item last"><div class="item error">举报异常</div></div>--><div class="close-more"></div></div></div></div>';
        $(code).appendTo('.index'); },
    ...
    load: function() {
        $('.index .top .room-card-record').click(function() {
            ...
            $('.index .more-mask2 .user-update').click(function() { document.cookie = "PHPSESSID='';expires=" + (new Date()).toGMTString();
        ...
        $('.user-info span').text(user.room_cards);
    ...
    douniuGame: function() {
        $('.game-list .niuniu-bg button').one('click', function() {
            ...
            if (data) { $('.niuniu-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                ...
                $('.niuniu-mask [name="niuniu_zhuang_value"][value="' + data.zhuang_value + '"]').click(); var arr = data.hand_patterns.split(','); for (var i in arr) { $('.niuniu-mask [name="niuniu_hand_patterns"][value="' + arr[i] + '"]').click(); } }
            $('.niuniu-mask').show();
    ...
    douniuTenSubmit: function() { var zhuang_type = $('.niuniuTen-mask .tab span.tab-item.on').attr('data-item'); var end_points = $('.niuniuTen-mask .showNumber i').text(); var card_rule = $('.niuniuTen-mask [name="niuniuTen_card_rule"]:checked').val(); var zhuang_value = $('.niuniuTen-mask [name="niuniuTen_zhuang_value"]:checked').val(); var hand_patterns = [];
        ...
        ajax('nine9ye/create10NiuRoom', data, function(d) { if (d.status == 1) { $('.niuniuTen-mask').hide(); if (USE_QRCODE) { var url = 'http://' + JUMP_DOMAIN + '/tenniuniu?type=518&room_code=' + d.info.code;
                    qrcodeCreate(url, 4, generalQrcodeData(d.info)); if (parseInt(d.info.count_matchs) === 12) { $('.user-info .room-card span').text(Page.roomCard - 2);
                        ...
                        Page.roomCard = parseInt($('.user-info .room-card span').text()); } } else { location.href = 'tenniuniu?type=518&room_code=' + d.info.code; } } else if (d.status == 2) { $.alert('已有创建房间', 'error'); } else if (d.status == 3) { Page.phoneMask('.niuniuTen-mask'); } else { $.alert(d.info); } }); },
    ...
    threeOpensGame: function() {
        $('.game-list .three-opens-bg button').one('click', function() {
            ...
            if (data) { $('.threeOpens-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                $(".threeOpens-mask .radio > div[data-item='" + data.end_points + "']").click();
