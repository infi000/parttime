...
<head lang="zh-cn">
    ...
    <title>飞鹰大厅</title>
    <meta name="apple-mobile-web-app-title" content="飞鹰大厅\" />
    ...
    *:after {
    ...
    .index {
        padding-top: 1.4400rem;
        width: 100%;
        height: 100%;
        position: fixed;
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-bg.jpg") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .top .issue-room-card {
        right: .6816rem;
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-card.png") no-repeat;
        background-size: 100% 100%;
    }

    .top .room-card-record {
        right: .0096rem;
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-more.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .game-list .game-item.niuniu-bg {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-bull6.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.goldflower-bg {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-goldflow.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.niuniuTen-bg {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-bull10.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.thirteencard-bg {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-thirteencard.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.three-opens-bg {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-sangong.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.texas-poker-bg {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-texas2.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.texas-poker-bg1 {
        background: url("http://cdn.lfzgame.com/images/laopengyouqipai/ting-texas1.png") no-repeat;
        background-size: 100% 100%;
    }
...
var Page = {
    ...
    moreFunc: function() { var code = '<div class="more-mask2"><div class="content-mask"><div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i><div class="content-item"><div class="item user-friend">好友管理</div></div><div class="content-item"><div class="item user-update">更新资料</div></div><div class="content-item"><div class="item more-room-card">房卡记录</div></div><div class="content-item"><div class="item log-out">注销登录</div></div><div class="content-item last"><div class="item error">举报异常</div></div><div class="close-more"></div></div></div></div>';
        $(code).appendTo('.index'); },
    ...
    douniuTenSubmit: function() { var zhuang_type = $('.niuniuTen-mask .tab span.tab-item.on').attr('data-item'); var end_points = $('.niuniuTen-mask .showNumber i').text(); var card_rule = $('.niuniuTen-mask [name="niuniuTen_card_rule"]:checked').val(); var zhuang_value = $('.niuniuTen-mask [name="niuniuTen_zhuang_value"]:checked').val(); var hand_patterns = [];
        ...
        ajax('nine9ye/create10NiuRoom', data, function(d) { if (d.status == 1) { $('.niuniuTen-mask').hide(); if (USE_QRCODE) { var url = 'http://' + JUMP_DOMAIN + '/tenniuniu?type=feiying&room_code=' + d.info.code;
                    qrcodeCreate(url, 4, generalQrcodeData(d.info)); if (parseInt(d.info.count_matchs) === 12) { $('.user-info .room-card span').text(Page.roomCard - 2);
                        ...
                        Page.roomCard = parseInt($('.user-info .room-card span').text()); } } else { location.href = 'tenniuniu?type=feiying&room_code=' + d.info.code; } } else if (d.status == 2) { $.alert('已有创建房间', 'error'); } else if (d.status == 3) { Page.phoneMask('.niuniuTen-mask'); } else { $.alert(d.info); } }); },
