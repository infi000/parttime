...
<head lang="zh-cn">
    ...
    <link rel="stylesheet" href="/static/css/room.css?171126"/>
</head><!--6474-->
<body><!--3897-->
<div id="loadings"
...
<div class="body">
    <div class="user-card hide-card show-card" data-pos="0" data-item="0">
        <div class="cardbox hind" data-item="0"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox hind" data-item="1"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox hind" data-item="2"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox hind" data-item="3"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox hind" data-item="4"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
    </div>
    <div class="user-card hide-card show-card" data-pos="1" data-item="1">
        <div class="cardbox card-small hind" data-item="0"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox card-small hind" data-item="1"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox card-small hind" data-item="2"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox card-small hind" data-item="3"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
        <div class="cardbox card-small hind" data-item="4"><span class="card" data-value="" data-color=""></span><span
                    class="card-bg"></span></div>
    </div>
    ...
    <div class="top flex-cont">
        ...
        <div class="right">
            <div class="rules-focus"><span class="rules"></span><span class="return-index"></span><span
                        class="game-tips"></span></div>
        </div>
    </div>
    ...
    <div class="bottom">
        ...
        <div class="music"><img src="http://static.wanzj.cn/images/niuniu/game-music02.png"><img
                    src="http://static.wanzj.cn/images/niuniu/game-music01.png"></div>
        <div class="chat"></div>
    ...
    <div class="time"></div>
    <div class="grabzhuang"><input type="button" data-item="9" data-value="1" value="1倍"><input type="button"
                                                                                                data-item="9"
                                                                                                data-value="2"
                                                                                                value="2倍"><input
                type="button" data-item="9" data-value="4" value="4倍"><input type="button" data-item="10" data-value="0"
                                                                             name="0" value="不抢"></div>
    ...
    <div class="banker"><span data-pos="0"></span><span data-pos="1"></span><span data-pos="2"></span><span
                data-pos="3"></span><span data-pos="4"></span><span data-pos="5"></span><span data-pos="6"></span><span
                data-pos="7"></span><span data-pos="8"></span><span data-pos="9"></span></div>
    <div class="player-number"><input type="button" data-value="1" value="1倍"><input type="button" data-value="2"
                                                                                     value="2倍"><input type="button"
                                                                                                       data-value="3"
                                                                                                       value="3倍"><input
                type="button" data-value="5" value="5倍"></div>
...
<script>/*8074*/
    ...
    var win = {
        ...
        readyJoin: function (code, func) {
            ajax('game/readyJoin', {code: code}, function (d) {
                ...
                if (typeof(d.info) != 'undefined') {
                    if (d.info == 0) {
                        ...
                        ajax('game/result', {code: Page.code}, function (data) {
                    ...
                    if (d.member == 1) {
                        ...
                        document.getElementById('requestBtn').onclick = function () {
                            ...
                            ajax('game/applyForFriend', {user_id: d.room_owner.id}, function (d) {
                                if (d.status == 1) {
                                } else {
                                }
                            })
    ...
    function createRanking(data, func) {
        ...
        for (var i in users) {
            if (/\/\/[064]{1,2}$/.test(users[i].path)) pics.push('http://static.wanzj.cn/images/default_head.png'); else pics.push(users[i].path.replace(/\/0$/, '/64').replace('http://wx.qlogo.cn/', 'http://img.wanzj.cn/'));
        }
        var count = 0, imgs = [];
        for (var i in pics) {
            if (XMLHttpRequest)
    ...
    function generalRule(game_id, game_data, parent) {
        ...
        var ruleJson = {
            ...
            '5': {
                ...
                'init_points': {
                    'text': '初始分数 :',
                    'value': {'500': '       500', '1000': '       1000', '1500': '       1500', '2000': '       2000'}
                }
            },
            '6': {
            ...
            ltime: 0, status: 0, speed: 5, num: 0, failcount: 0, start: function () {
                ...
                setTimeout(function () {
                    ...
                    if (that.num >= that.speed) {
                        if ((new Date()).getTime() - that.ltime >= 3000) {
                            that.failcount++;
                            if (that.failcount > 3) {
    ...
    var Page = {
        ...
        load: function () {
            ...
            $('.focus-mask .focus-img img').attr('src', 'http://static.wanzj.cn/images/qrcode-' + win.sign + '.jpg');
            ...
            win.readyJoin(Page.code, function () {
                ws.connect('game/douniuTen', function () {
    ...
    var game = {
        lost_value: '', get_value: '', showdown_users: [], zhuang_type: 0, init: function (d) {
            var user_list = d.room_users;
            if (user_list) {
            ...
            if (d.info) {
                ...
                Page.shareData = {
                    ...
                    link: location.href,
                    path: 'http://static.wanzj.cn/images/niuniuten/share-niuniuten.jpg'
                };
            ...
            if (!handCard) {
                ...
                var card0 = parseInt(handCard[0].value), card1 = parseInt(handCard[1].value),
            ...
            if (game.lost_value > 0 && game.get_value > 0) {
                ...
                setTimeout(score, 1000);
                setTimeout(resetGame, 4500);
            }else if (game.lost_value == 0 && game.get_value == 0) {
    ...
    function Player(user_id, nickname, path, is_join, value) {
        ...
        this.getUserDom = function () {
            ...
            code += '    <div class="user-img"><img src="' + this.path + '" onerror="this.src=\'http://static.wanzj.cn/images/ucenter/user.png\'"></div>';
...
sound.source.bgm = "http://m8.biuxl.top/static/music/bgm.mp3";
sound.source.gold = "http://m8.biuxl.top/static/music/gold.mp3";
sound.source.sound_1_0 = "http://m8.biuxl.top/static/music/sound_1_0.mp3";
sound.source.sound_1_1 = "http://m8.biuxl.top/static/music/sound_1_1.mp3";
sound.source.sound_1_10 = "http://m8.biuxl.top/static/music/sound_1_10.mp3";
sound.source.sound_1_11 = "http://m8.biuxl.top/static/music/sound_1_11.mp3";
sound.source.sound_1_12 = "http://m8.biuxl.top/static/music/sound_1_12.mp3";
