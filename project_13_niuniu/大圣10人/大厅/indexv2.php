...
<head lang="zh-cn">
    ...
    <link rel="stylesheet" href="/static/css/index.css?171128"/>
</head><!--6474-->
<body><!--3897-->
<div id="loadings"
...
<div class="index">
    <div class="top">
        <div class="user">
            ...
            <div class="user-info">
                <div class="name"></div>
                <div class="room-card"><img src="http://static.wanzj.cn/images/index/room-card1.png" alt=""
                                            onerror="this.src='http://static.wanzj.cn/images/index/room-card1.png'"><span></span>
                </div>
                <!--&lt;!&ndash;<img src="http://static.wanzj.cn/images/index/user-id.png"alt=""onerror="this.src='http://static.wanzj.cn/images/index/user-id.png'">&ndash;&gt;-->
            </div>
        </div>
    ...
    <div class="pupop-container niuniuTen-mask">
        <div class="niuniu-opacity">
            <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i
                        class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                <div class="tab"><span class="tab-item on" data-item='1'>明牌<br>抢庄</span><span class="tab-item"
                                                                                              data-item='2'>通比<br>牛牛</span><span
                            class="tab-item" data-item='3'>自由<br>抢庄</span><span class="tab-item" data-item='4'>牛牛<br>上庄</span><span
                            class="tab-item" data-item='5'>固定<br>庄家</span></div>
                <div class="content-item">
                    <div class="content">
                        <div class="flex-cont number">
                            ...
                            <div class="flex-cont flex-item">
                                ...
                                <div class="radio flex-item">
                                    ...
                                    <span class="showNumber" data-pos="1"><i>1</i></span></div>
                                <div class="next">+</div>
                            </div>
                        </div>
                        <div class="flex-cont rules">
                            <div class="name">规则:</div>
                            <div class="flex-item"><label><input type="radio" name="niuniuTen_card_rule" value="1"
                                                                 checked><span>牛牛×3 牛九×2 牛八×2</span></label><br><label><input
                                            type="radio" name="niuniuTen_card_rule"
                                            value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label></div>
                        </div>
                        ...
                        <div class="flex-cont innings">
                            ...
                            <div class="flex-item"><label><input type="radio" name="niuniuTen_max_matches" value="12"
                                                                 checked><span>12局<img class="mask-inning-card"
                                                                                       src="http://static.wanzj.cn/images/index/mask-inning-card.png">X2</span></label><label><input
                                            type="radio" name="niuniuTen_max_matches" value="24"><span>24局<img
                                                class="mask-inning-card"
                                                src="http://static.wanzj.cn/images/index/mask-inning-card.png">X4</span></label>
                            </div>
                        </div>
            ...
            <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i
                ...
                <div class="content-item">
                    <div class="content">
                        ...
                        <div class="flex-cont rules">
                            <div class="name">规则:</div>
                            <div class="flex-item"><label><input type="radio" name="niuniu_card_rule" value="1" checked><span>牛牛×3 牛九×2 牛八×2</span></label><br><label><input
                                            type="radio" name="niuniu_card_rule"
                                            value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label></div>
                        </div>
                        <div class="flex-cont type">
                            <div class="name">牌型:</div>
                        ...
                        <div class="flex-cont innings">
                            <div class="name">局数:</div>
                            <div class="flex-item"><label><input type="radio" name="niuniu_max_matches" value="10"
                                                                 checked><span>10局<img class="mask-inning-card"
                                                                                       src="http://static.wanzj.cn/images/index/mask-inning-card.png">X1</span></label><label><input
                                            type="radio" name="niuniu_max_matches" value="20"><span>20局<img
                                                class="mask-inning-card"
                                                src="http://static.wanzj.cn/images/index/mask-inning-card.png">X2</span></label>
                            </div>
                        </div>
                        <div class="zhuang"></div>
                    </div>
                ...
                <div class="content-item">
                    <div class="content">
                        <div class="flex-cont number">
                            ...
                            <div class="flex-cont flex-item">
                                ...
                                <div class="radio flex-item">
                                    ...
                                    <span class="showNumber" data-pos="1"><i>2</i></span></div>
                                <div class="next2">+</div>
                            </div>
                        </div>
                        <div class="flex-cont rules">
                            <div class="name">分数:</div>
                            <div class="flex-item"><label><input type="radio" name="gold_card_rule" value="1"
                                                                 checked><span>2/4，4/8，8/16，10/20</span></label><br><label><input
                                            type="radio" name="gold_card_rule"
                                            value="2"><span>2/4，5/10，10/20，20/40</span></label></div>
                        </div>
                        <div class="flex-cont innings">
                            <div class="name">局数:</div>
                            <div class="flex-item"><label><input type="radio" name="gold_max_matches" value="10"
                                                                 checked><span>10局<img class="mask-inning-card"
                                                                                       src="http://static.wanzj.cn/images/index/mask-inning-card.png">X1</span></label><label><input
                                            type="radio" name="gold_max_matches" value="20"><span>20局<img
                                                class="mask-inning-card"
                                                src="http://static.wanzj.cn/images/index/mask-inning-card.png">X2</span></label>
                            </div>
                        </div>
                        <div class="flex-cont goldflower-number">
                            ...
                            <div class="flex-item"><label><input type="radio" name="gold_hand_patterns" value="0"><span>无</span></label><label><input
                                            type="radio" name="gold_hand_patterns" value="500" checked><span>500</span></label><label><input
                                            type="radio" name="gold_hand_patterns"
                                            value="1000"><span>1000</span></label><label><input type="radio"
                                                                                                name="gold_hand_patterns"
                ...
                <div class="content-item">
                    <div class="content">
                        <div class="flex-cont">
                            ...
                            <label><input type="radio" name="texasPoker_mang" checked value="1"><span>1/2</span></label><label><input
                                        type="radio" name="texasPoker_mang" value="2"><span>2/4</span></label></div>
                        <div class="flex-cont">
                            <div class="title-text">局数:</div>
                            <label><input type="radio" name="texasPoker_jushu" checked value="10"><span>10局<img
                                            class="mask-inning-card"
                                            src="http://static.wanzj.cn/images/index/mask-inning-card.png">X2</span></label><label><input
                                        type="radio" name="texasPoker_jushu" value="20"><span>20局<img
                                            class="mask-inning-card"
                                            src="http://static.wanzj.cn/images/index/mask-inning-card.png">X4</span></label>
                        </div>
                        <div class="flex-cont">
                            <div class="title-text">前注:</div>
                            <label><input type="radio" name="texasPoker_zhu" checked
                                          value="0"><span>无</span></label><label><input type="radio"
                                                                                        name="texasPoker_zhu" value="1"><span>1倍小盲</span></label><label><input
                                        type="radio" name="texasPoker_zhu" value="2"><span>2倍小盲</span></label></div>
                        <div class="flex-cont">
                            <div class="title-text">初始分数:</div>
                            <label><input type="radio" name="texasPoker_chip" checked
                                          value="500"><span>500</span></label><label><input type="radio"
                                                                                            name="texasPoker_chip"
                                                                                            value="1000"><span>1000</span></label><label><input
                                        type="radio" name="texasPoker_chip"
                                        value="1500"><span>1500</span></label><label><input type="radio"
                                                                                            name="texasPoker_chip"
                                                                                            value="2000"><span>2000</span></label>
                        </div>
                    </div>
                ...
                <div class="content-item">
                    <div class="content">
                        ...
                        <div class="flex-cont type">
                            ...
                            <div class="flex-item"><label><input type="checkbox" name="thirteen_hand_patterns" value="1"
                                                                 checked disabled><span>经典</span></label></div>
                        </div>
                        <div class="flex-cont innings">
                            <div class="name">局数:</div>
                            <div class="flex-item"><label><input type="radio" name="thirteen_max_matches" value="5"
                                                                 checked><span>5局<img class="mask-inning-card"
                                                                                      src="http://static.wanzj.cn/images/index/mask-inning-card.png">X1</span></label><label><input
                                            type="radio" name="thirteen_max_matches" value="10"><span>10局<img
                                                class="mask-inning-card"
                                                src="http://static.wanzj.cn/images/index/mask-inning-card.png">X2</span></label><label><input
                                            type="radio" name="thirteen_max_matches" value="20"><span>20局<img
                                                class="mask-inning-card"
                                                src="http://static.wanzj.cn/images/index/mask-inning-card.png">X4</span></label>
                            </div>
                        </div>
    ...
    <div class="pupop-container threeOpens-mask">
        <div class="niuniu-opacity">
            <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i
                        class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                <div class="tab"><span class="tab-item on" data-item='1'>抢庄模式</span><span class="tab-item"
                                                                                          data-item='2'>通比模式</span><span
                            class="tab-item" data-item='3'>三公当庄</span></div>
                <div class="content-item">
                    <div class="content">
                        <div class="flex-cont number">
                            <div class="nameText">底分</div>
                        ...
                        <div class="flex-cont matches">
                            <div class="name">局数:</div>
                            <div class="flex-item"><label><input type="radio" name="threeOpens_max_matches" value="12"
                                                                 checked><span>12局<img class="mask-inning-card"
                                                                                       src="http://static.wanzj.cn/images/index/mask-inning-card.png">X2</span></label><label><input
                                            type="radio" name="threeOpens_max_matches" value="24"><span>24局<img
                                                class="mask-inning-card"
                                                src="http://static.wanzj.cn/images/index/mask-inning-card.png">X4</span></label>
                            </div>
                        </div>
...
<script>
    ...
    function createRanking(data, func) {
        ...
        for (var i in users) {
            if (/\/\/[064]{1,2}$/.test(users[i].path)) pics.push('images/default_head.png'); else pics.push(users[i].path.replace(/\/0$/, '/64').replace('https://wx.qlogo.cn/', 'http://113.96.232.104/'));
        }
        var count = 0, imgs = [];
        for (var i in pics) {
            if (XMLHttpRequest)
    ...
    var Page = {
        picData: [], picText: '', time: 0, roomCard: 0, phoneCode: function () {
            ...
            $('.index .top .room-card-record').click(function () {
                ...
                $('.index .more-mask2 .pk-history').click(function () {
                    location.href = 'pkquery';
                });
                $('.index .more-mask2 .more-room-card').click(function () {
                    window.location.href = 'checkRecord';
                });
            ...
            Page.threeOpensGame();
            Page.texasPokerGame();
            $('.niuniu-mask .createRoomBtn').on('click', function () {
                if (Page.time == 0) {
                    Page.time = 2;
                    var index = setInterval(function () {
                        Page.time--;
            ...
            $('.niuniuTen-mask .createRoomBtn').on('click', function () {
                if (Page.time == 0) {
                    Page.time = 2;
                    var index = setInterval(function () {
                        Page.time--;
            ...
            $('.goldflower-mask .createRoomBtn').on('click', function () {
                if (Page.time == 0) {
                    Page.time = 2;
                    var index = setInterval(function () {
                        Page.time--;
            ...
            $('.thirteencard-mask .createRoomBtn').on('click', function () {
                if (Page.time == 0) {
                    Page.time = 2;
                    var index = setInterval(function () {
                        Page.time--;
            ...
            $('.threeOpens-mask .createRoomBtn').on('click', function () {
                if (Page.time == 0) {
                    Page.time = 2;
                    var index = setInterval(function () {
                        Page.time--;
            ...
            $('.texas-poker-mask .createRoomBtn').on('click', function () {
                if (Page.time == 0) {
                    Page.time = 2;
                    var index = setInterval(function () {
                        Page.time--;
            ...
            fileInput.change(function () {
                if (this.files.length > 0) {
                    ...
                    if (size[1] == 0)
                        var cvs = $('<canvas>').width(size[0]).attr('width', size[0]); else
            ...
            $('.game-list .niuniu-bg').one('click', function () {
                ...
                $('.niuniu-mask').show();
                $('.game-list .niuniu-bg').on('click', function () {
                    $('.niuniu-mask').show();
                });
            });
            ...
            ajax('home/gameDouniu/createRoom', data, function (d) {
                if (d.status == 1) {
                    $('.niuniu-mask').hide();
                    if (USE_QRCODE) {
                        var url = 'http://' + JUMP_DOMAIN + '/gamedouniu?code=' + d.info.code;
                        ...
                        location.href = 'gamedouniu?code=' + d.info.code;
                    }
                } else if (d.status == 2) {
                    ...
                    code += '    </div>';
                    code += '    <a class="go-room" href="gamedouniu?code=' + d.info + '">前往房间</a>';
            ...
            $('.game-list .niuniuTen-bg ').one('click', function () {
                ...
                $('.niuniuTen-mask').show();
                $('.game-list .niuniuTen-bg ').on('click', function () {
                    $('.niuniuTen-mask').show();
                });
            });
            ...
            ajax('home/gameDouniuTen/createRoom', data, function (d) {
                if (d.status == 1) {
                    $('.niuniuTen-mask').hide();
                    if (USE_QRCODE) {
            ...
            $('.game-list .goldflower-bg ').one('click', function () {
                ...
                $('.game-list .goldflower-bg ').on('click', function () {
                    $('.goldflower-mask').show();
                });
            });
            ...
            ajax('home/GameJinhua/createRoom', data, function (d) {
                if (d.status == 1) {
                    $('.goldflower-mask').hide();
                    if (USE_QRCODE) {
                        var url = 'http://' + JUMP_DOMAIN + '/goldFlower?code=' + d.info.code;
                        ...
                        location.href = 'goldFlower?code=' + d.info.code;
                    }
                } else if (d.status == 3) {
            ...
            $('.game-list .thirteencard-bg ').one('click', function () {
                ...
                $('.game-list .thirteencard-bg ').on('click', function () {
                    $('.thirteencard-mask').show();
                });
            });
            ...
            ajax('home/gameThirteen/createRoom', data, function (d) {
                if (d.status == 1) {
                    $('.thirteencard-mask').hide();
                    if (USE_QRCODE) {
                        var url = 'http://' + JUMP_DOMAIN + '/thirteen?code=' + d.info.code;
                        ...
                        location.href = 'thirteen?code=' + d.info.code;
                    }
                } else if (d.status == 3) {
            ...
            $('.game-list .three-opens-bg').one('click', function () {
                ...
                $('.game-list .three-opens-bg ').on('click', function () {
                    $('.threeOpens-mask').show();
                });
            });
            ...
            ajax('home/gameSanGong/createRoom', data, function (d) {
                if (d.status == 1) {
                    $('.threeOpens-mask').hide();
                    if (USE_QRCODE) {
                        var url = 'http://' + JUMP_DOMAIN + '/threeOpens?code=' + d.info.code;
                        ...
                        location.href = 'threeOpens?code=' + d.info.code;
                    }
                } else if (d.status == 2) {
                    $.alert('已有创建房间', 'error');
                } else if (d.status == 3) {
            ...
            $('.game-list .texas-poker-bg ').one('click', function () {
                ...
                $('.game-list .texas-poker-bg ').on('click', function () {
                    $('.texas-poker-mask').show();
                });
            });
            ...
            var data = {'texas_end_points': mang, 'max_matches': innings, 'end_points_rule': zhu, 'init_points': chip};
            storage.set('roomrule_texasPoker', data);
            ajax('home/GameTexas/createRoom', data, function (d) {
                if (d.status == 1) {
                    $('.texas-poker-mask').hide();
                    if (USE_QRCODE) {
                        var url = 'http://' + JUMP_DOMAIN + '/texasHoldem?code=' + d.info.code;
                        ...
                        location.href = 'texasHoldem?code=' + d.info.code;
                    }
                } else if (d.status == 3) {
...
<script>
    ...
    const DOMAIN = 'qaz.agosv.cn';
    const API_DOMAIN = 'qaz.agosv.cn';
    const WS_DOMAIN = '111.230.23.129:8084';
    const JUMP_DOMAIN = 'qaz.agosv.cn';
    const USE_QRCODE = 0;
    const IS_SSL = false;
    win.version = '1.0.0';
    win.sign = 'dashengzhongyu';
    win.token = 'NWlmZDRwMDhubWEwczh0YXBwZXQ4Z2Z2ZG4=';
    notice.data = '';
    var user = {
        "id": "206116",
        "wechat_id": "1",
