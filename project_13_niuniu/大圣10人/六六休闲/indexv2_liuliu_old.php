...
<head lang="zh-cn">
    ...
    <title>六六休闲</title>
    <meta name="apple-mobile-web-app-title" content="六六休闲" />
    ...
    *:after {
    ...
    .game-list .game-item.niuniu-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/bull.png") no-repeat;
        background-size: 100% 100%;
    }
...
<body>
    ...
    <div class="index">
        <div class="top">
            ...
            <button class="issue-room-card" onclick="location.href='createGift.html'">发放房卡</button>
            <button class="room-card-record">更多功能</button>
        </div>
        <div class="game-list" style="overflow: hidden;">
...
var Page = {
    ...
    moreFunc: function() { var code = '<div class="more-mask2"><div class="content-mask"><div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i><div class="content-item"><div class="item user-friend">好友管理</div></div><div class="content-item"><div class="item pk-history">历史战绩</div></div><div class="content-item"><div class="item more-room-card">房卡记录</div></div><div class="content-item"><div class="item log-out">注销登录</div></div><div class="content-item last"><div class="item error">举报异常</div></div><div class="close-more"></div></div></div></div>';
        $(code).appendTo('.index'); },
    ...
    fillingPitCardGame: function() {
        $('.game-list .fillingPitcard-bg button').one('click', function() {
            ...
            $('.game-list .fillingPitcard-bg button').on('click', function() { $('.fillingPitcard-mask').show(); });
    ...
    fillingPitCardSubmit: function() {
        ...
        ajax('home/gameFillingpit/createRoom', data, function(d) { if (d.status == 1) { location.href = 'fillingPit.html?code=' + d.info; } else if (d.status == 3) { Page.phoneMask('.fillingPitcard-mask'); } else { $.alert(d.info); } });
    },
