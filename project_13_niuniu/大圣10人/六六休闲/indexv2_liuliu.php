...
<head lang="zh-cn">
    ...
    <title>六六闲约</title>
    <meta name="apple-mobile-web-app-title" content="六六闲约" />
    ...
    *:after {
    ...
    .window-masks.agreement .border-opacity-v2 .container {
        position: relative;
        padding: .3840rem .1440rem .0480rem;
    }

    .window-masks.agreement .border-opacity-v2 .container .title {
        position: absolute;
        top: .0960rem;
        left: 0;
        right: 0;
    ...
    .window-masks.agreement .border-opacity-v2 .container .main {
        width: 2.6896rem;
        padding: .0864rem;
    ...
    .window-masks.agreement .border-opacity-v2 .container .sure {
        position: relative;
        width: 1.0272rem;
        height: .3696rem;
        line-height: 2;
        ...
        color: #fff;
        text-align: center;
        background: url("http://cdn.lfzgame.com/images/decIndex/button3.png") no-repeat;
        background-size: 100% 100%;
    }

    .window-masks.agreement .border-opacity-thirteen .container {
        position: relative;
    }

    .window-masks.agreement .border-opacity-thirteen .container .title {
        padding: .2rem;
        background: url(http://cdn.lfzgame.com/images/niuniuthirteen/agreement-title.png) no-repeat center center;
        background-size: .9408rem .2496rem;
    }

    .window-masks.agreement .border-opacity-thirteen .container .main {
        width: 2.6896rem;
        padding: .0864rem;
        border: .0048rem solid #19256d;
        -webkit-border-radius: .076rem;
    ...
    .window-masks.agreement .border-opacity-thirteen .container .sure {
        position: relative;
        width: 1.0272rem;
        height: .3696rem;
        line-height: 2;
        ...
        color: #fff;
        text-align: center;
        background: url("http://cdn.lfzgame.com/images/niuniuthirteen/agreementSure.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .window-masks.return-index .border-opacity-v2 .container .sure {
        background: url("http://cdn.lfzgame.com/images/decIndex/button1.png") no-repeat;
        background-size: 100% 100%;
    ...
    .window-masks.return-index .border-opacity-v2 .container .cancel {
        background: url("http://cdn.lfzgame.com/images/decIndex/button2.png") no-repeat;
        background-size: 100% 100%;
        -webkit-text-stroke-width: 0.0048rem;
    ...
    .window-masks.return-index .border-opacity-thirteen .container .sure {
        background: url("http://cdn.lfzgame.com/images/niuniuthirteen/return-index-btn.png") no-repeat;
        background-size: 100% 100%;
    }

    .window-masks.return-index .border-opacity-thirteen .container .cancel {
        background: url("http://cdn.lfzgame.com/images/niuniuthirteen/cancel.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    *:after {
    ...
    .index {
        ...
        height: 100%;
        position: fixed;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-bg1.jpg") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .more-mask2 .content-mask .content-box {
        position: relative;
        -webkit-border-radius: .0480rem;
        -moz-border-radius: .0480rem;
        border-radius: .0480rem;
        background-color: #232a44;
        border: .0192rem solid #6e5d3e;
        padding: .1440rem 0 .0480rem 0;
        text-align: center;
        font-size: 0;
    }

    .more-mask2 .content-mask .content-box .content-item {
        position: relative;
        height: .4992rem;
        width: 2.5440rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-line-bg.png") no-repeat center bottom;
        background-size: 100% auto;
        margin-bottom: .0960rem;
    }

    .more-mask2 .content-mask .content-box .content-item.last {
        background: none;
    }

    .more-mask2 .content-mask .content-box .content-item .item {
        display: inline-block;
        width: 1.5360rem;
        height: .3840rem;
    }

    .more-mask2 .content-mask .content-box .content-item .item.pk-history {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/more-item02.png") no-repeat;
        background-size: 100% 100%;
    }

    .more-mask2 .content-mask .content-box .content-item .item.user-friend {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/more-item01.png") no-repeat;
        background-size: 100% 100%;
    }

    .more-mask2 .content-mask .content-box .content-item .item.switch {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/more-item06.png") no-repeat;
        background-size: 100% 100%;
    }

    .more-mask2 .content-mask .content-box .content-item .more-room-card {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/more-item03.png") no-repeat;
        background-size: 100% 100%;
    }

    .more-mask2 .content-mask .content-box .content-item .item.log-out {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/more-item04.png") no-repeat;
        background-size: 100% 100%;
    }

    .more-mask2 .content-mask .content-box .content-item .item.error {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/more-item05.png") no-repeat;
        background-size: 100% 100%;
    }

    .more-mask2 .content-mask .content-box .close-more,
    .picture-mask .picture-box .close-more {
        position: absolute;
        left: 0;
        right: 0;
        bottom: -.4800rem;
        ...
        width: .3264rem;
        height: .3264rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-close.png") no-repeat;
        background-size: 100% 100%;
    ...
    .picture-mask .picture-box .content {
        padding: .0720rem;
    }

    .picture-mask .picture-box .content .content-bg {
        position: relative;
        min-height: 1.6320rem;
        width: 2.5440rem;
        padding: .1200rem .0720rem;
        background-color: #d1e2f6;
        -webkit-border-radius: .0480rem;
        -moz-border-radius: .0480rem;
        border-radius: .0480rem;
    ...
    .picture-mask .picture-box .content .content-bg .text {
        position: relative;
        margin: 0 auto;
        width: 98%;
        height: .5280rem;
        background-color: #bdd3ed;
        border: .0096rem solid #e6f1fb;
        -webkit-box-shadow: 0 .0144rem 0 #91b3de inset;
        -moz-box-shadow: 0 .0144rem 0 #91b3de inset;
        box-shadow: 0 .0144rem 0 #91b3de inset;
        -webkit-border-radius: .0240rem;
        -moz-border-radius: .0240rem;
        border-radius: .0240rem;
        padding: .0960rem .0480rem;
        resize: none;
        color: #333;
    }

    .picture-mask .picture-box .content .content-bg .container {
        position: relative;
        min-height: 1rem;
        text-align: left;
        font-size: 0;
        background: url("http://cdn.lfzgame.com/images/index/mask-tips-text.png") no-repeat center bottom;
        background-size: 100% auto;
    }

    .picture-mask .picture-box .content .content-bg .container .pic {
        display: inline-block;
        width: .3936rem;
        height: .3936rem;
        -webkit-border-radius: .0240rem;
    ...
    .picture-mask .picture-box .content .content-bg .container .pic img {
        float: left;
    }

    .picture-mask .picture-box .content .content-bg .container .upload {
        position: relative;
        display: inline-block;
        border: .0192rem solid #bdd3ed;
        width: .3936rem;
        height: .3936rem;
        -webkit-border-radius: .0240rem;
        -moz-border-radius: .0240rem;
    ...
    .picture-mask .picture-box .content .content-bg .upload:after {
        content: '';
        position: absolute;
        left: 0;
        top: 0;
    ...
    .picture-mask .picture-box .content .content-bg .upload:before {
        content: '';
        position: absolute;
        left: 0;
        top: 0;
    ...
    .picture-mask .picture-box .content .content-bg .container .upload.uploadColor {
        border: .0192rem solid #d9e5f2;
    }

    .picture-mask .picture-box .content .content-bg .container .upload.uploadColor:before,
    .picture-mask .picture-box .content .content-bg .container .upload.uploadColor:after {
        background-color: #d9e5f2;
    }

    .picture-mask .picture-box .content .content-bg .text::-webkit-input-placeholder {
        color: #8f867e;
    }

    .picture-mask .picture-box .submit {
        position: relative;
        width: 1.2192rem;
        height: .4032rem;
        margin: .0960rem auto;
        background: url("http://cdn.lfzgame.com/images/index/submit.png") no-repeat;
        background-size: 100% 100%;
    }

    .picture-mask .picture-box .submit2 {
        position: relative;
        width: 1.2192rem;
        height: .4032rem;
        line-height: .4032rem;
        ...
        font-size: .1920rem;
        background-color: #bdd3ed;
        border: .0096rem solid #d1e2f6;
        -webkit-border-radius: .2016rem;
        -moz-border-radius: .2016rem;
        border-radius: .2016rem;
        margin: .0960rem auto;
    }
    ...
    .top {
        ...
        width: 100%;
        height: .5856rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/head-bg.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .top .room-card span {
        ...
        line-height: .1920rem;
        text-align: right;
        padding: 0 .0720rem 0 .048rem;
        font-size: .1152rem;
        color: #fff;
        background-color: #1d2148;
        -webkit-border-radius: 0 .0960rem .0960rem 0;
        -moz-border-radius: 0 .0960rem .0960rem 0;
        border-radius: 0 .0960rem .0960rem 0;
        border: .0096rem solid #3f487d;
        vertical-align: middle;
    }
    ...
    .top .user-id span {
        ...
        line-height: .1440rem;
        text-align: right;
        padding: 0 .0720rem 0 .0720rem;
        font-size: .1152rem;
        color: #fff;
        background-color: rgba(0, 0, 0, .5);
        -webkit-border-radius: .0960rem;
        -moz-border-radius: .0960rem;
        border-radius: .0960rem;
        border: .0096rem solid #3f487d;
        vertical-align: middle;
    }

    .top .issue-room-card,
    .top .room-card-record {
        position: absolute;
        top: .0768rem;
        width: .6528rem;
        height: .4320rem;
    ...
    .top .issue-room-card {
        right: .6816rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/money-card.png") no-repeat;
        background-size: 100% 100%;
    }

    .top .room-card-record {
        right: .0096rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-more.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .game-list .game-item {
        ...
        width: 1.4496rem;
        height: 1.4016rem;
        margin: 0 .0720rem .2304rem;
    }

    .game-list .game-item button {
        position: absolute;
        left: 0;
        right: 0;
        bottom: 0;
    ...
    .game-list .game-item.niuniu-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/bull1.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.niuniuSix-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/bull6.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.niuniuNine-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/bull9.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.goldflower-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/jinhua.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.niuniuTen-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/bull10.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.thirteencard-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/thirteen-card.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.three-opens-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/sangong.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.texas-poker-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/texas-poker.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.fillingPitcard-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/filling-pit.png") no-repeat;
        background-size: 100% 100%;
    }

    .game-list .game-item.thirteenoxen-bg {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/bull13.png") no-repeat;
        background-size: 100% 100%;
    }
    ...
    .pupop-container .niuniu-opacity {
        position: absolute;
        left: 50%;
        top: 50%;
    ...
    .pupop-container .tab span {
        ...
        font-size: .1440rem;
        color: #fff0c3;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/tab-item01.png") no-repeat;
        background-size: 100% 100%;
        margin: 0 .0096rem;
    }

    .pupop-container.threeOpens-mask .tab span {}

    .pupop-container .tab span[data-item='1'] {}

    .pupop-container .tab span.on {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/tab-item02.png") no-repeat;
        background-size: 100% 100%;
        font-weight: bold;
        color: #fffbef;
    ...
    .pupop-container .tab span.on:after {
        position: absolute;
        left: 0;
        right: 0;
        bottom: -.0480rem;
        ...
        width: .1536rem;
        height: .1104rem;
        background: url("http://cdn.lfzgame.com/images/index/niuniu-tab-after1.png") no-repeat;
        background-size: 100% 100%;
    }

    .pupop-container .content-box {
        position: relative;
        margin: auto;
        padding: .0864rem .0864rem .2400rem .0864rem;
        background-color: #232a44;
        -webkit-border-radius: .0768rem;
        -moz-border-radius: .0768rem;
        border-radius: .0768rem;
        border: .0096rem solid #6e5d3e;
    }

    .pupop-container .content-box:before,
    .picture-mask .picture-box .content .content-bg:before,
    .more-mask2 .content-box:before {
        position: absolute;
        top: 1%;
        left: 2%;
        width: 96%;
    ...
    .pupop-container .content-item {
        position: relative;
        padding: .0720rem;
    }

    .pupop-container .content-item .mask-inning-card {
        width: .2208rem;
        height: .1488rem;
        vertical-align: -.024rem;
        margin: 0 .0240rem;
    }

    .pupop-container .content-box .niuniu-tit {
        position: absolute;
        left: 0;
        right: 0;
        top: -.2688rem;
        ...
        height: .1968rem;
        margin: auto;
        background: url("http://cdn.lfzgame.com/images/index/niuniu-mask-tit.png") no-repeat;
        background-size: 100% 100%;
    }

    .pupop-container .content-box .close-window {
        position: absolute;
        left: 0;
        right: 0;
        bottom: -.5760rem;
    ...
    .pupop-container .text {
        width: 100%;
        text-align: center;
        line-height: .2400rem;
        font-size: .1200rem;
        color: #e8b24c;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-line-bg.png")no-repeat left bottom;
        background-size: 100% auto;
        padding-bottom: .0576rem;
    }

    .pupop-container .content-box .createRoomBtn {
        position: relative;
        margin: .0960rem auto 0;
        display: block;
        width: 1.0368rem;
        height: .3744rem;
        font-size: 0;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/sure-btn01.png") no-repeat;
        background-size: 100% 100%;
    }

    .pupop-container .content>.flex-cont,
    .pupop-container .content .zhuang>.flex-cont,
    .pupop-container .content .zhuangType>.flex-cont {
        width: 100%;
        margin: 0 0 .0720rem 0;
        padding: .0720rem 0 .0720rem .0720rem;
        border-radius: .0672rem;
        font-size: 0;
        background-color: #4458ae;
        -webkit-box-shadow: 0 .0144rem .0144rem #050712;
        -moz-box-shadow: 0 .0144rem .0144rem #050712;
        box-shadow: 0 .0144rem .0144rem #050712;
    }

    .pupop-container .content>.flex-cont label,
    .pupop-container .content .zhuang>.flex-cont label,
    .pupop-container .content .zhuangType>.flex-cont label {
        font-size: .1296rem;
        padding: .0480rem 0;
        color: #e8b24c;
        display: inline-block;
    ...
    .pupop-container .content>.flex-cont label span,
    .pupop-container .content .zhuang>.flex-cont label span,
    .pupop-container .content .zhuangType>.flex-cont label span {
        vertical-align: middle;
    }

    .pupop-container .flex-cont div span {
        vertical-align: middle;
    }

    .pupop-container .content>.flex-cont .name,
    .pupop-container .content .zhuang>.flex-cont .name,
    .pupop-container .content .zhuangType>.flex-cont .name {
        margin: 0 .048rem;
    ...
    .pupop-container .content>.flex-cont input,
    .pupop-container .content .zhuang>.flex-cont input,
    .pupop-container .content .zhuangType>.flex-cont input,
    .withGod,
    .withGodBoom {
        margin: 0 .048rem 0 0;
        width: .1584rem;
        ...
        position: relative;
        padding: 0;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-radio01.png") no-repeat;
        background-size: 100% 100%;
        text-align: center;
    }
    ...
    .pupop-container .content>.flex-cont input:checked,
    .pupop-container .content .zhuang>.flex-cont input:checked,
    .pupop-container .content .zhuangType>.flex-cont input:checked {
        vertical-align: middle;
    }

    .pupop-container .content>.flex-cont input:checked+span,
    .pupop-container .content .zhuang>.flex-cont input:checked+span,
    .pupop-container .content .zhuangType>.flex-cont input:checked+span {
        color: #ffd380;
    }

    .pupop-container .content>.flex-cont input:checked:after,
    .pupop-container .content .zhuang>.flex-cont input:checked:after,
    .pupop-container .content .zhuangType>.flex-cont input:checked:after,
    .withGodChecked:after {
        content: '';
        position: absolute;
        left: 0;
        right: 0;
        ...
        bottom: 0;
        margin: auto;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-radio.png") no-repeat;
        background-size: 100% 100%;
        border-radius: 100%;
    }
    ...
    .pupop-container .content>.flex-cont.type input {
        width: .1440rem;
        height: .1440rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-checkbox01.png") no-repeat;
        background-size: 100% 100%;
    }

    .pupop-container .content>.flex-cont.type input:checked:after {
        background: none;
    }

    .pupop-container .content>.flex-cont.type input:checked:before {
        content: '';
        position: absolute;
        left: 50%;
        top: 50%;
        ...
        width: .1680rem;
        height: .1584rem;
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/game-checkbox.png") no-repeat;
        background-size: 100% 100%;
    }

    .pupop-container .content>.flex-cont.innings label {
        margin-right: .1440rem;
    }

    .pupop-container .content>.flex-cont.number {
        position: relative;
        font-size: .1200rem;
        height: .6720rem;
        padding: .2880rem .1440rem .0960rem .1440rem;
    }

    .pupop-container .content>.flex-cont.number>.flex-item {
        -webkit-align-items: center;
        align-items: center;
    }

    .pupop-container .content>.flex-cont.number .nameText {
        position: absolute;
        left: 0;
        top: .1440rem;
        width: 100%;
    ...
    .pupop-container .content>.flex-cont.number .prev2,
    .pupop-container .content>.flex-cont.number .next2,
    .pupop-container .content>.flex-cont.number .prev,
    .pupop-container .content>.flex-cont.number .next {
        position: relative;
        width: .2880rem;
        height: .2880rem;
        border: .0240rem solid #e8b24c;
        -webkit-border-radius: 50%;
        -moz-border-radius: 50%;
        border-radius: 50%;
        font-size: 0;
    ...
    .pupop-container .content>.flex-cont.number .prev2:after,
    .pupop-container .content>.flex-cont.number .next2:after,
    .pupop-container .content>.flex-cont.number .next2:before,
    .pupop-container .content>.flex-cont.number .prev:after,
    .pupop-container .content>.flex-cont.number .next:after,
    .pupop-container .content>.flex-cont.number .next:before {
        content: '';
        position: absolute;
        top: 0;
        right: 0;
    ...
    .pupop-container .content>.flex-cont.number .radio {
        position: relative;
        margin: 0 .1200rem;
        height: .1248rem;
        line-height: .1248rem;
    ...
    .pupop-container .content>.flex-cont.number .radio div {
        position: relative;
        width: .2400rem;
        height: .2400rem;
        z-index: 3;
    ...
    .pupop-container .content>.flex-cont.number .radio div:after {
        content: '';
        position: absolute;
        left: 50%;
        top: 50%;
    ...
    .pupop-container .content>.flex-cont.number .radio div.on {
        z-index: 1;
    }

    .pupop-container .content>.flex-cont.number .showNumber {
        position: absolute;
        left: 0;
        top: 50%;
        z-index: 2;
    ...
    .pupop-container .content>.flex-cont.number .showNumber[data-pos="1"],
    .pupop-container .content>.flex-cont.number .showNumber[data-item="2"],
    .pupop-container .content>.flex-cont.number .showNumber[data-item="5"],
    .pupop-container.thirteencard-mask .content>.flex-cont.number .showNumber[data-item="1"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-pos="1"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-item="5"],
    .pupop-container.fillingPitcard-mask .content>.flex-cont.number .showNumber[data-item="1"] {
        width: .0960rem;
    }

    .pupop-container .content>.flex-cont.number .showNumber[data-pos="2"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-pos="2"] {
        width: 27%;
    }

    .pupop-container .content>.flex-cont.number .showNumber[data-pos="3"],
    .pupop-container .content>.flex-cont.number .showNumber[data-item="4"],
    .pupop-container .content>.flex-cont.number .showNumber[data-item="10"],
    .pupop-container.thirteencard-mask .content>.flex-cont.number .showNumber[data-item="3"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-pos="3"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-item="10"],
    .pupop-container.fillingPitcard-mask .content>.flex-cont.number .showNumber[data-item="3"] {
        width: 52%;
    }

    .pupop-container .content>.flex-cont.number .showNumber[data-pos="4"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-pos="4"] {
        width: 75%;
    }

    .pupop-container .content>.flex-cont.number .showNumber[data-pos="5"],
    .pupop-container .content>.flex-cont.number .showNumber[data-item="8"],
    .pupop-container .content>.flex-cont.number .showNumber[data-item="20"],
    .pupop-container.thirteencard-mask .content>.flex-cont.number .showNumber[data-item="5"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-pos="5"],
    .pupop-container.threeOpens-mask .content>.flex-cont.number .showNumber[data-item="20"],
    .pupop-container.fillingPitcard-mask .content>.flex-cont.number .showNumber[data-item="5"] {
        width: 100%;
    }

    .pupop-container .content>.flex-cont.number .showNumber i {
        position: absolute;
        right: 0;
        top: -50%;
        ...
        -moz-border-radius: 100%;
        border-radius: 100%;
        background-color: #5f7bf4;
        -webkit-box-shadow: 0 .0144rem .0144rem#1a2574;
        -moz-box-shadow: 0 .0144rem .0144rem#1a2574;
        box-shadow: 0 .0144rem .0144rem#1a2574;
    }

    .pupop-container .content>.flex-cont.number input:checked:after {
        content: normal;
    }

    .goldflower-number label,
    .pupop-container .content .zhuang label {
        margin-right: .1440rem;
    }

    .pupop-container .content .zhuang {}

    .goldflower-mask {
        display: none;
    }

    .goldflower-mask .opacity,
    .texas-poker-mask .opacity {
        position: absolute;
        left: 50%;
        top: 50%;
        -webkit-transform: translate(-50%, -54%);
    ...
    .pupop-container.thirteencard-mask .tab span {
        -webkit-flex: 1;
        flex: 1;
    }

    .thirteencard-mask .thirteencard-tips {
        color: #8f5936;
        font-size: .1296rem;
        text-align: center;
    }

    .pupop-container.thirteencard-mask .content>.flex-cont.type label {
        width: 33.333%;
    }

    .pupop-container.thirteencard-mask .content>.flex-cont.innings label {
        margin: 0;
        width: 50%;
    }
    ...
    .pupop-container.threeOpens-mask .tab {
        background: none;
    }
    ...
    .pupop-container.threeOpens-mask .tab span.on {
        background: url("http://cdn.lfzgame.com/images/liuliuxianyue/tab-item02.png") no-repeat;
        background-size: 100% 100%;
        font-weight: bold;
        color: #fffbef;
    ...
    .pupop-container.threeOpens-mask .content>.flex-cont label,
    .pupop-container .content .zhuangType>.flex-cont label {
        width: 45%;
    }
    ...
    .texas-poker-mask .content>.flex-cont {
        position: relative;
        padding-top: .1920rem;
        padding-left: 0;
        margin-bottom: .1440rem;
    }

    .texas-poker-mask .content>.flex-cont .title-text {
        color: #e8b24c;
        font-size: .1440rem;
        width: .7200rem;
        text-align: right;
    ...
    .texas-poker-mask .content>.flex-cont label {
        -webkit-flex: 1;
        flex: 1;
    }
    ...
    .pupop-container.fillingPitcard-mask .tab span {
        -webkit-flex: 1;
        flex: 1;
    }

    .fillingPitcard-mask .fillingPitcard-tips {
        color: #8f5936;
        font-size: .1296rem;
        text-align: center;
    }

    .pupop-container.fillingPitcard-mask .content>.flex-cont.type label {
        width: 100%;
    }

    .pupop-container.fillingPitcard-mask .content>.flex-cont.loves label {
        margin: 0;
        width: 25%;
    }

    .pupop-container.fillingPitcard-mask .content>.flex-cont.others .flex-item div {
        margin: 0;
        width: 50%;
        font-size: .1296rem;
        padding: .0480rem 0;
    ...
    .pupop-container.fillingPitcard-mask .content>.flex-cont.innings label {
        margin: 0;
        width: 50%;
    }

    .pupop-container.fillingPitcard-mask .content-box .close-window {
        bottom: -.4800rem;
    }
...
<body>
    ...
    <div class="index">
        <div class="top">
            <div class="user">
                <div class="user-img"><img src="" onerror="this.src='../images/ucenter/user.png'"></div>
                <div class="user-info">
                    <div class="name"></div>
                    <div class="room-card"><img src="http://cdn.lfzgame.com/images/liuliuxianyue/game-room-card.png" alt="" onerror="this.src='http://cdn.lfzgame.com/images/liuliuxianyue/game-room-card.png'"><span></span></div>
                </div>
            </div>
            <button class="issue-room-card" onclick="location.href='createGift'">发放房卡</button>
            <button class="room-card-record">更多功能</button>
        </div>
        <div class="game-list">
            <div class="game-item niuniuTen-bg">
                <button>创建房间</button>
            </div>
            <div class="game-item niuniu-bg">
                <button>创建房间</button>
            </div>
            <div class="game-item thirteenoxen-bg">
                <button>创建房间</button>
            </div>
            ...
            <div class="game-item fillingPitcard-bg">
                <button>创建房间</button>
            </div>
        </div>
        <div class="pupop-container niuniu-mask">
            <div class="niuniu-opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="tab"><span class="tab-item on" data-item='1'>明牌<br>抢庄</span><span class="tab-item" data-item='2'>通比<br>牛牛</span><span class="tab-item" data-item='3'>自由<br>抢庄</span><span class="tab-item" data-item='4'>牛牛<br>上庄</span><span class="tab-item" data-item='5'>固定<br>庄家</span></div>
                    <div class="content-item">
                        <div class="content">
                            <div class="flex-cont number">
                                <div class="nameText">底分（计分牌）</div>
                                <div class="flex-cont flex-item">
                                    ...
                                    <div class="radio flex-item">
                                        ...
                                        <div data-item="5" data-pos="5"></div><span class="showNumber" data-pos="1"><i>1</i></span></div>
                                    <div class="next">+</div>
                                </div>
                            </div>
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniu_card_rule" value="1" checked><span>牛牛×3 牛九×2 牛八×2</span></label>
                                    <br>
                                    <label>
                                        <input type="radio" name="niuniu_card_rule" value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label>
                                </div>
                            </div>
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniu_max_matches" value="10" checked><span>10局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X1</span></label>
                                    <label>
                                        <input type="radio" name="niuniu_max_matches" value="20"><span>20局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
                    </div>
                    <div class="text">创建房间，无人参与，半小时后返还房卡</div>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuTen_card_rule" value="1" checked><span>牛牛×3 牛九×2 牛八×2</span></label>
                                    <br>
                                    <label>
                                        <input type="radio" name="niuniuTen_card_rule" value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label>
                                </div>
                            </div>
                            <div class="flex-cont type">
                                <div class="name">牌型:</div>
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuTen_max_matches" value="12" checked><span>12局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                    <label>
                                        <input type="radio" name="niuniuTen_max_matches" value="24"><span>24局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X4</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
        ...
        <div class="pupop-container niuniuThirteen-mask">
            <div class="niuniu-opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="tab"><span class="tab-item on" data-item='1'>明牌<br>抢庄</span><span class="tab-item" data-item='2'>通比<br>牛牛</span><span class="tab-item" data-item='3'>自由<br>抢庄</span><span class="tab-item" data-item='4'>牛牛<br>上庄</span><span class="tab-item" data-item='5'>固定<br>庄家</span></div>
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuThirteen_card_rule" value="1" checked><span>牛牛×3 牛九×2 牛八×2</span></label>
                                    <br>
                                    <label>
                                        <input type="radio" name="niuniuThirteen_card_rule" value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label>
                                </div>
                            </div>
                            <div class="flex-cont type">
                                <div class="name">牌型:</div>
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuThirteen_max_matches" value="12" checked><span>12局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X3</span></label>
                                    <label>
                                        <input type="radio" name="niuniuThirteen_max_matches" value="24"><span>24局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X6</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
        ...
        <div class="pupop-container niuniuSix-mask">
            <div class="niuniu-opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="tab"><span class="tab-item on" data-item='1'>明牌<br>抢庄</span><span class="tab-item" data-item='2'>通比<br>牛牛</span><span class="tab-item" data-item='3'>自由<br>抢庄</span><span class="tab-item" data-item='4'>牛牛<br>上庄</span><span class="tab-item" data-item='5'>固定<br>庄家</span></div>
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuSix_card_rule" value="1" checked><span>牛牛×3 牛九×2 牛八×2</span></label>
                                    <br>
                                    <label>
                                        <input type="radio" name="niuniuSix_card_rule" value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label>
                                </div>
                            </div>
                            <div class="flex-cont type">
                                <div class="name">牌型:</div>
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuSix_max_matches" value="10" checked><span>10局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X1</span></label>
                                    <label>
                                        <input type="radio" name="niuniuSix_max_matches" value="20"><span>20局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
        ...
        <div class="pupop-container niuniuNine-mask">
            <div class="niuniu-opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="tab"><span class="tab-item on" data-item='1'>明牌<br>抢庄</span><span class="tab-item" data-item='2'>通比<br>牛牛</span><span class="tab-item" data-item='3'>自由<br>抢庄</span><span class="tab-item" data-item='4'>牛牛<br>上庄</span><span class="tab-item" data-item='5'>固定<br>庄家</span></div>
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuNine_card_rule" value="1" checked><span>牛牛×3 牛九×2 牛八×2</span></label>
                                    <br>
                                    <label>
                                        <input type="radio" name="niuniuNine_card_rule" value="2"><span>牛牛×4 牛九×3 牛八×2 牛七×2</span></label>
                                </div>
                            </div>
                            <div class="flex-cont type">
                                <div class="name">牌型:</div>
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="niuniuNine_max_matches" value="12" checked><span>12局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                    <label>
                                        <input type="radio" name="niuniuNine_max_matches" value="24"><span>24局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X4</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
            ...
            <div class="opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="content-item">
                        <div class="content">
                            <div class="flex-cont number">
                                <div class="nameText">底分</div>
                                <div class="flex-cont flex-item">
                                    <div class="prev2">-</div>
                                    <div class="radio flex-item">
                                        <div class="on" data-item="2" data-pos="1"></div>
                                        <div data-item="4" data-pos="2"></div>
                                        <div data-item="8" data-pos="3"></div><span class="showNumber" data-pos="1"><i>2</i></span></div>
                                    <div class="next2">+</div>
                                </div>
                            </div>
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="gold_card_rule" value="1" checked><span>2/4，4/8，8/16，10/20</span></label>
                                    <br>
                                    <label>
                                        <input type="radio" name="gold_card_rule" value="2"><span>2/4，5/10，10/20，20/40</span></label>
                                </div>
                            </div>
                            <div class="flex-cont innings">
                                <div class="name">局数:</div>
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="gold_max_matches" value="10" checked><span>10局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X1</span></label>
                                    <label>
                                        <input type="radio" name="gold_max_matches" value="20"><span>20局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                </div>
                            </div>
                            <div class="flex-cont goldflower-number">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="gold_hand_patterns" value="0"><span>无</span></label>
                                    <label>
                                        <input type="radio" name="gold_hand_patterns" value="500" checked><span>500</span></label>
                                    <label>
                                        <input type="radio" name="gold_hand_patterns" value="1000"><span>1000</span></label>
                                    <label>
                                        <input type="radio" name="gold_hand_patterns" value="2000"><span>2000</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="content-item">
                        <div class="content">
                            <div class="flex-cont">
                                <div class="title-text">小盲/大盲:</div>
                                <label>
                                    <input type="radio" name="texasPoker_mang" checked value="1"><span>1/2</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_mang" value="2"><span>2/4</span></label>
                            </div>
                            <div class="flex-cont">
                                <div class="title-text">局数:</div>
                                <label>
                                    <input type="radio" name="texasPoker_jushu" checked value="10"><span>10局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_jushu" value="20"><span>20局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X4</span></label>
                            </div>
                            <div class="flex-cont">
                                <div class="title-text">前注:</div>
                                <label>
                                    <input type="radio" name="texasPoker_zhu" checked value="0"><span>无</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_zhu" value="1"><span>1倍小盲</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_zhu" value="2"><span>2倍小盲</span></label>
                            </div>
                            <div class="flex-cont">
                                <div class="title-text">初始分数:</div>
                                <label>
                                    <input type="radio" name="texasPoker_chip" checked value="500"><span>500</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_chip" value="1000"><span>1000</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_chip" value="1500"><span>1500</span></label>
                                <label>
                                    <input type="radio" name="texasPoker_chip" value="2000"><span>2000</span></label>
                            </div>
                        </div>
                    </div>
                    <div class="text">创建房间，无人参与，半小时后返还房卡</div>
                            ...
                            <div class="flex-cont number">
                                ...
                                <div class="flex-cont flex-item">
                                    ...
                                    <div class="radio flex-item">
                                        ...
                                        <div data-item="5" data-pos="3"></div><span class="showNumber" data-pos="1"><i>1</i></span></div>
                                    <div class="next">+</div>
                                </div>
                            </div>
                            <div class="flex-cont type">
                                <div class="name">玩法:</div>
                                <div class="flex-item">
                                    <label>
                                        <input type="checkbox" name="thirteen_hand_patterns" value="1" checked disabled><span>经典</span></label>
                                </div>
                            </div>
                            <div class="flex-cont innings">
                                <div class="name">局数:</div>
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="thirteen_max_matches" value="5" checked><span>5局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X1</span></label>
                                    <label>
                                        <input type="radio" name="thirteen_max_matches" value="10"><span>10局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                    <label>
                                        <input type="radio" name="thirteen_max_matches" value="20"><span>20局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X4</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="pupop-container threeOpens-mask">
            <div class="niuniu-opacity">
                <div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i>
                    <div class="tab"><span class="tab-item on" data-item='1'>抢庄模式</span><span class="tab-item" data-item='2'>通比模式</span><span class="tab-item" data-item='3'>三公当庄</span></div>
                    <div class="content-item">
                        <div class="content">
                            <div class="flex-cont number">
                                <div class="nameText">底分</div>
                            ...
                            <div class="flex-cont matches">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="threeOpens_max_matches" value="12" checked><span>12局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X2</span></label>
                                    <label>
                                        <input type="radio" name="threeOpens_max_matches" value="24"><span>24局<img class="mask-inning-card"src="http://cdn.lfzgame.com/images/index/mask-inning-card.png">X4</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="pupop-container fillingPitcard-mask">
            <div class="niuniu-opacity">
                <div class="content-box">
                    <div class="content-item">
                        <div class="content">
                            <div class="flex-cont number">
                                <div class="nameText">底注</div>
                                <div class="flex-cont flex-item">
                                    <div class="prev">-</div>
                                    <div class="radio flex-item">
                                        <div class="on" data-item="1" data-pos="1"></div>
                            ...
                            <div class="flex-cont type">
                                ...
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="fillingPit_hand_patterns" value="1" checked><span>半坑（满5人10起）</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_hand_patterns" value="2"><span>半坑（满5人9起）</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_hand_patterns" value="3"><span>半坑（满4人J起）</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_hand_patterns" value="4"><span>全坑（2-A）</span></label>
                                    <label>
                                        <input type="checkbox" name="fillingPit_dogfall" value="1"><span>烂锅翻倍</span></label>
                                </div>
                            </div>
                            <div class="flex-cont loves">
                                <div class="name">喜分:</div>
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="fillingPit_loves" value="1" checked><span>1</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_loves" value="2"><span>2</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_loves" value="3"><span>3</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_loves" value="5"><span>5</span></label>
                                </div>
                            </div>
                            <div class="flex-cont others">
                                <div class="name">其他:</div>
                                <div class="flex-item">
                                    <div class="fillingPit_others_one"><span class="withGod" name="fillingPit_others" value="1"></span><span>带王</span></div>
                                    <div class="fillingPit_others_two"><span class="withGodBoom" name="fillingPit_others" value="2"></span><span>王中炮</span></div>
                                </div>
                            </div>
                            <div class="flex-cont innings">
                                <div class="name">局数:</div>
                                <div class="flex-item">
                                    <label>
                                        <input type="radio" name="fillingPit_max_matches" value="10" checked><span>10局×1房卡</span></label>
                                    <label>
                                        <input type="radio" name="fillingPit_max_matches" value="20"><span>20局×2房卡</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
...
var qrcode = function(typeNumber, errorCorrectLevel) {
    ...
    var makeImpl = function(test, maskPattern) {
        ...
        _modules = function(moduleCount) {
            ...
            for (var row = 0; row < moduleCount; row += 1) { modules[row] = new Array(moduleCount); for (var col = 0; col < moduleCount; col += 1) { modules[row][col] = null; } }
            return modules;
        }(_moduleCount);
    ...
    var getBestMaskPattern = function() {
        var minLostPoint = 0;
        var pattern = 0;
        for (var i = 0; i < 8; i += 1) { makeImpl(true, i); var lostPoint = QRUtil.getLostPoint(_this); if (i == 0 || minLostPoint > lostPoint) { minLostPoint = lostPoint;
                pattern = i; } }
        return pattern;
    };
    ...
    var setupPositionAdjustPattern = function() {
        ...
        for (var i = 0; i < pos.length; i += 1) {
            for (var j = 0; j < pos.length; j += 1) {
                ...
                for (var r = -2; r <= 2; r += 1) { for (var c = -2; c <= 2; c += 1) { if (r == -2 || r == 2 || c == -2 || c == 2 || (r == 0 && c == 0)) { _modules[row + r][col + c] = true; } else { _modules[row + r][col + c] = false; } } }
            }
        }
    };
    var setupTypeNumber = function(test) {
        var bits = QRUtil.getBCHTypeNumber(_typeNumber);
        for (var i = 0; i < 18; i += 1) { var mod = (!test && ((bits >> i) & 1) == 1);
    ...
    var setupTypeInfo = function(test, maskPattern) {
        ...
        for (var i = 0; i < 15; i += 1) { var mod = (!test && ((bits >> i) & 1) == 1); if (i < 6) { _modules[i][8] = mod; } else if (i < 8) { _modules[i + 1][8] = mod; } else { _modules[_moduleCount - 15 + i][8] = mod; } }
            ...
            while (true) {
                for (var c = 0; c < 2; c += 1) {
                    if (_modules[row][col - c] == null) {
                        ...
                        bitIndex -= 1;
                        if (bitIndex == -1) { byteIndex += 1;
                            bitIndex = 7; }
                    }
                }
                row += inc;
                if (row < 0 || _moduleCount <= row) { row -= inc;
                    inc = -inc; break; }
            }
        }
    };
    var createBytes = function(buffer, rsBlocks) {
        ...
        for (var r = 0; r < rsBlocks.length; r += 1) {
            ...
            for (var i = 0; i < ecdata[r].length; i += 1) { var modIndex = i + modPoly.getLength() - ecdata[r].length;
    ...
    var createData = function(typeNumber, errorCorrectLevel, dataList) {
        ...
        for (var i = 0; i < dataList.length; i += 1) { var data = dataList[i];
    ...
    _this.addData = function(data) { var newData = qr8BitByte(data);
    ...
    _this.createTableTag = function(cellSize, margin) {
        ...
        for (var r = 0; r < _this.getModuleCount(); r += 1) {
            qrHtml += '<tr>';
            for (var c = 0; c < _this.getModuleCount(); c += 1) { qrHtml += '<td style="';
                qrHtml += ' border-width: 0px; border-style: none;';
                qrHtml += ' border-collapse: collapse;';
    ...
    _this.createImgTag = function(cellSize, margin, size) { cellSize = cellSize || 2;
        margin = (typeof margin == 'undefined') ? cellSize * 4 : margin; var min = margin; var max = _this.getModuleCount() * cellSize + margin; return createImgTag(size, size, function(x, y) { if (min <= x && x < max && min <= y && y < max) { var c = Math.floor((x - min) / cellSize); var r = Math.floor((y - min) / cellSize); return _this.isDark(r, c) ? 0 : 1; } else { return 1; } }); };
    return _this;
};
qrcode.stringToBytes = function(s) {
    var bytes = [];
    for (var i = 0; i < s.length; i += 1) { var c = s.charCodeAt(i);
        bytes.push(c & 0xff); }
    return bytes;
};
qrcode.createStringToBytes = function(unicodeData, numChars) {
    var unicodeMap = function() {
        ...
        var read = function() { var b = bin.read(); if (b == -1) throw new Error(); return b; };
        var count = 0;
        var unicodeMap = {};
        while (true) { var b0 = bin.read(); if (b0 == -1) break; var b1 = read(); var b2 = read(); var b3 = read(); var k = String.fromCharCode((b0 << 8) | b1); var v = (b2 << 8) | b3;
            unicodeMap[k] = v;
            count += 1; }
    ...
    return function(s) {
        var bytes = [];
        for (var i = 0; i < s.length; i += 1) { var c = s.charCodeAt(i); if (c < 128) { bytes.push(c); } else { var b = unicodeMap[s.charAt(i)]; if (typeof b == 'number') { if ((b & 0xff) == b) { bytes.push(b); } else { bytes.push(b >>> 8);
                        bytes.push(b & 0xff); } } else { bytes.push(unknownChar); } } }
        return bytes;
    };
};
...
var QRUtil = function() {
    ...
    _this.getLengthInBits = function(mode, type) { if (1 <= type && type < 10) { switch (mode) {
...
var QRRSBlock = function() {
    ...
    var qrRSBlock = function(totalCount, dataCount) { var _this = {};
        _this.totalCount = totalCount;
        _this.dataCount = dataCount; return _this; };
    var _this = {};
...
var qr8BitByte = function(data) {
    ...
    for (var i = 0, l = _data.length; i < l; i++) {
        ...
        if (code > 0x10000) { byteArray[0] = 0xF0 | ((code & 0x1C0000) >>> 18);
    ...
    if (_parsedData.length != _data.length) { _parsedData.unshift(191);
...
var byteArrayOutputStream = function() {
    ...
    _this.writeShort = function(i) { _this.writeByte(i);
        _this.writeByte(i >>> 8); };
    _this.writeBytes = function(b, off, len) { off = off || 0;
...
var base64EncodeOutputStream = function() {
    ...
    var encode = function(n) {
        if (n < 0) {} else if (n < 26) { return 0x41 + n; } else if (n < 52) { return 0x61 + (n - 26); } else if (n < 62) { return 0x30 + (n - 52); } else if (n == 62) { return 0x2b; } else if (n == 63) { return 0x2f; }
        throw new Error('n:' + n);
    };
    _this.writeByte = function(n) { _buffer = (_buffer << 8) | (n & 0xff);
        _buflen += 8;
        _length += 1; while (_buflen >= 6) { writeEncoded(_buffer >>> (_buflen - 6));
            _buflen -= 6; } };
...
var base64DecodeInputStream = function(str) {
    ...
    _this.read = function() {
        while (_buflen < 8) {
            ...
            _pos += 1;
            if (c == '=') { _buflen = 0; return -1; } else if (c.match(/^\s$/)) { continue; }
    ...
    var decode = function(c) { if (0x41 <= c && c <= 0x5a) { return c - 0x41; } else if (0x61 <= c && c <= 0x7a) { return c - 0x61 + 26; } else if (0x30 <= c && c <= 0x39) { return c - 0x30 + 52; } else if (c == 0x2b) { return 62; } else if (c == 0x2f) { return 63; } else { throw new Error('c:' + c); } };
    return _this;
};
var gifImage = function(width, height) {
    ...
    _this.write = function(out) {
        ...
        var offset = 0;
        while (raster.length - offset > 255) { out.writeByte(255);
    ...
    var bitOutputStream = function(out) {
        ...
        _this.write = function(data, length) {
            ...
            while (_bitLength + length >= 8) { _out.writeByte(0xff & ((data << _bitLength) | _bitBuffer));
                length -= (8 - _bitLength);
                data >>>= (8 - _bitLength);
                _bitBuffer = 0;
                _bitLength = 0; }
    ...
    var getLZWRaster = function(lzwMinCodeSize) {
        ...
        while (dataIndex < _data.length) {
            ...
            dataIndex += 1;
            if (table.contains(s + c)) { s = s + c; } else {
...
function setTitle(title) { document.title = title; if (/ip(hone|od|ad)/i.test(navigator.userAgent)) { var i = document.createElement('iframe');
        i.src = '/favicon.ico';
            ...
            if (typeof(d.info) != 'undefined') {
                if (d.info == 0) { alert2('加入房间失败', function() { wx.closeWindow(); }); } else if (d.info == -1) { alert2('房间号错误', function() { wx.closeWindow(); }); } else if (d.info == 1) {
                    ...
                    ajax('home/index/result', { code: Page.code }, function(data) {
                        ...
                        if (win.sign == 'xinjia') {
                            createRankingV2(data, function(d) {
                                var img = new Image();
                ...
                if (d.first_join || d.first_join == 1) {
                    if (win.version == '1.0.0') {
                        ...
                        if (parseInt(d.game) === 1 || parseInt(d.game) === 4 || parseInt(d.game) === 8 || parseInt(d.game) === 9 || parseInt(d.game) === 10 || parseInt(d.game) === 11) {
                            ...
                            if (parseInt(win.gameId) === 10 || parseInt(win.gameId) === 11) { if (parseInt(d.max_matches) === 12) { maxMatchesText = '12局×3房卡 '; } else if (parseInt(d.max_matches) === 24) { maxMatchesText = '24局×6房卡 '; } }
                            ...
                            if (parseInt(d.max_matches) === 10) { sanMatches = '10局×1房卡 '; } else if (parseInt(d.max_matches) === 12) { sanMatches = '12局×2房卡 '; } else if (parseInt(d.max_matches) === 20) { sanMatches = '20局×2房卡 '; } else if (parseInt(d.max_matches) === 24) { sanMatches = '24局×4房卡 '; }
                        ...
                        joinUser += '</div>';
                        if (user_list.length > 10) { joinUser += '<div class="user-list user-list2">'; } else { joinUser += '<div class="user-list">'; }
    ...
    if (id_bol) {
        ...
        for (var z = 0; z < source.length; z++) {
            ...
            for (var i = 0; i < count; i++) { var coin = new jinbi(gold_w, gold_h);
                ...
                coins.push(coin);
                _str_a.push({ "x": coin.x, "y": coin.y });
                _str_b.push({ "x": $target.position().left + Math.round(Math.random() * ($target.children('.user-img').width() * 0.62)), "y": $target.position().top + Math.round(Math.random() * ($target.children('.user-img').width() * 0.62)) }); }
            obj.push(coins);
            str.push(_str_a);
            str1.push(_str_b);
        }
...
function createRanking(data, func) {
    ...
    for (var i in users) { if (/\/\/[064]{1,2}$/.test(users[i].path)) pics.push('http://cdn.lfzgame.com/images/default_head.png');
    ...
    for (var i in pics) {
        ...
        xhr.onload = function() {
            var img = document.createElement("img");
            if (this.status == 200) { img.src = window.URL.createObjectURL(this.response); } else { this.src = 'http://cdn.lfzgame.com/images/default_head.png'; }
...
function createRankingV2(data, func) {
    ...
    if (users.length > 6) { pics.push('http://cdn.lfzgame.com/images/decIndex/people_bg2.jpg');
    ...
    function draw() {
        ...
        for (var i in users) {
            ...
            if (txt != '') row.push(txt);
            if (row.length == 1) { context.fillText(row[0], 184, 445 + 96 * i); } else { context.fillText(row[0], 184, 425 + 96 * i);
                context.fillText(row[1], 184, 455 + 96 * i); }
            if (row[0] && row[1]) { textWidthObj = (context.measureText(row[0]).width > context.measureText(row[1]).width ? context.measureText(row[0]).width : context.measureText(row[1]).width); } else { textWidthObj = context.measureText(row[0]).width; }
            context.font = "36px 微软雅黑";
            context.textAlign = 'center';
            if (users[i]['value'] > 0) { context.fillStyle = "#cd5908";
                context.fillText('+' + users[i]['value'], 580, 445 + 96 * i); } else if (users[i]['value'] < 0) { context.fillStyle = "#32b16c";
                context.fillText(users[i]['value'], 580, 445 + 96 * i); } else { context.fillStyle = "#989898";
            ...
            if (users[i]['value'] == users[0]['value']) {
                ...
                if (playerNameLength > 415) { playerNameLength = 415; }
...
function isChinese(val) { var reg = new RegExp("[\\u4E00-\\u9FFF]+", "g"); if (reg.test(val)) { return true; } else { return false; } }
...
function Agreement() { var code = '<div class="window-masks agreement" id="agreement">';
    ...
    code += '</div>';
    document.getElementsByTagName('body')[0].insertAdjacentHTML("beforeend", code);
    document.getElementById('agreementSure').onclick = function() { document.body.removeChild(document.getElementById('agreement')); };
    document.getElementById('agreement').onclick = function() { if (document.getElementById('agreement')) { document.body.removeChild(document.getElementById('agreement')); } }; }

function AgreementV2() { var code = '<div class="window-masks agreement" id="agreement">';
    code += '<div class="border-opacity-v2">';
    code += '<div class="container">';
    code += '    <div class="title">用户协议</div>';
    code += '    <div class="main">';
    code += '       <p>本游戏仅供娱乐， 严禁赌博，如发现有赌博行为，将封停账号并向公安机关举报。</p>';
    code += '       <p>游戏中使用到的房卡为游戏道具，不具有任何财产性功能，本公司对于用户所拥有的房卡不提供任何形式官方回购、直接或变相兑换现金或实物等服务或相关功能。</p>';
    code += '       <p>游戏仅供休闲娱乐使用，游戏中出现问题请联系客服。</p>';
...
function AgreementThirteen() { var code = '<div class="window-masks agreement" id="agreement">';
...
function returnIndex(text) { var text = text || '确认返回主页？'; var code = '<div class="window-masks return-index" id="returnIndex">';
    ...
    document.getElementById('returnIndex').onclick = function() { if (document.getElementById('returnIndex')) { document.body.removeChild(document.getElementById('returnIndex')); } }; }

function returnIndexV2(text) { var text = text || '确认返回主页？'; var code = '<div class="window-masks return-index" id="returnIndex">';
    code += '<div class="border-opacity-v2">';
    code += '<div class="container">';
    code += '<div class="main">' + text + '</div>';
    code += '<div class="button">';
...
function returnIndexThirteen(text) { var text = text || '确认返回主页？'; var code = '<div class="window-masks return-index" id="returnIndex">';
    code += '<div class="border-opacity-thirteen">';
    code += '<div class="container">';
    code += '<div class="main">' + text + '</div>';
    code += '<div class="button">';
...
function getShareIconLink(game_id) {
    var shareLinkJson = { '1': 'niuniu', '2': 'jinhua', '3': 'shisanshui', '4': 'niuniuten', '5': 'texasholdem', '6': 'sangong', '7': 'tiandakeng', '8': 'bull6', '9': 'bull9', '10': 'bull12', '11': 'bull13', '12': 'sangongsix', '13': 'sangongnine' }
    var gameVersionJson = { 'bailexiuxian': '2', 'chaowenzhongyu': '2', 'dahonghuaqipai': '2', 'dashengzhongyu': '2', 'fuchenghuyu': '1', 'haichaoyouxi': '2', 'hongtaohuyu': '1', 'jingongmenhuyu': '2', 'laopengyouqipai': '1', 'lekuyoule': '2', 'leyueguibinting': '2', 'lianyundating': '3', 'liuliulexiang': '3', 'liuliuxianyue': '3', 'shouquandating': '2', 'wuyibahuyu': '1', 'xianshihuyu': '1', 'yingduoduo': '1', 'huangguanhuyu': '2', 'test': '2', 'ceshi': '2', 'xinjia': '4' }
...
var notice = {
    ...
    start: function() {
        var that = this;
        var datas = [];
        try { datas = JSON.parse(Base64.decode(this.data)); } catch (e) { return; }
...
var Page = {
    ...
    time: 0,
    roomCard: 0,
    phoneCode: function() { var mobile = $('.phone-number-box .mobile').val(); if (!mobile) { $.alert('请输入手机号码'); } else if (mobile.length != 11) { $.alert('请输入正确的手机号码'); } else if (mobile.length == 11) { ajax('home/User/sendMessage', { 'mobile': mobile }, function(d) { if (d.status == 0 || !d.status) { $.alert(d.info); } else if (d.status == 1) { var code = '<div class="phone-btn2">';
                    code += '       重新发送(<span>60</span>s)';
                    code += '    </div>';
                    $(code).appendTo('.phone-number-box .phone-code'); var times = 60; var phoneTime = setInterval(function() { times--; if (times <= 0) { $('.phone-number-box .phone-btn2').remove();
                            clearInterval(phoneTime); } else { $('.phone-number-box .phone-btn2 span').html(times); } }, 1000); } else { $.alert('错误操作'); } }) } },
    phoneNumberCode: function() { var mobile = $('.phone-number-box .mobile').val(); var mobileCode = $('.phone-number-box .mobile-code').val(); if (!mobile) { $.alert('请输入手机号码'); } else if (mobile.length != 11) { $.alert('请输入正确的手机号码'); } else if (!mobileCode) { $.alert('请输入验证码'); } else { ajax('home/User/registMobile', { 'mobile': mobile, 'code': mobileCode }, function(d) { if (d.status == 1) { $.alert(d.info);
                    $('.phone-number-box').remove(); } else if (d.status == 0 || !d.status) { $.alert(d.info); } }) } },
    moreFunc: function() { var code = '<div class="more-mask2"><div class="content-mask"><div class="content-box"><i class="mask-icon mask-top"></i><i class="mask-icon mask-right"></i><i class="mask-icon mask-bottom"></i><i class="mask-icon mask-left"></i><div class="content-item"><div class="item switch">切换平台</div></div><div class="content-item"><div class="item user-friend">好友管理</div></div><div class="content-item"><div class="item pk-history">历史战绩</div></div><div class="content-item"><div class="item more-room-card">房卡记录</div></div><div class="content-item"><div class="item log-out">注销登录</div></div><div class="content-item last"><div class="item error">举报异常</div></div><div class="close-more"></div></div></div></div>';
        $(code).appendTo('.index'); },
    picUpload: function() { var code = '<div class="picture-mask">';
    ...
    load: function() {
        $('.index .top .room-card-record').click(function() {
            Page.moreFunc();
            $('.index .more-mask2 .close-more').click(function() { $('.index .more-mask2').remove(); });
            $('.index .more-mask2 .user-friend').click(function() { location.href = 'permissions'; });
            $('.index .more-mask2 .pk-history').click(function() { location.href = 'pkquery'; });
            $('.index .more-mask2 .more-room-card').click(function() { window.location.href = 'checkRecord'; });
            $('.index .more-mask2 .log-out').click(function() { document.cookie = "PHPSESSID='';expires=" + (new Date()).toGMTString();
            ...
            $('.index .more-mask2 .error').click(function() {
                ...
                $('.index .picture-box .close-more').click(function() {
                    if ($('input[type="file"]')) { $('input[type="file"]').remove(); }
                    Page.picData = [];
                    $('.index .picture-mask').remove();
                });
                $('.index .picture-box .upload').click(function() { Page.pic_upload('.index .picture-box .upload', [640, 0], 0); });
                $('.index .picture-box .submit').click(function() { if (Page.time == 0) { Page.time = 3; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                        Page.picText = $('.index .picture-box .text').val(); if (!Page.picText) { $.alert('请输入文字说明！', 'error'); } else if (Page.picData.length == 0) { $.alert('请选择上传图片！', 'error'); } else { $('.picture-mask .content-bg .submit').remove();
                            $('<div class="submit2">').html('提交中...').appendTo('.picture-mask .content-bg');
                            ajax('home/user/postFeedback', { 'group_path': Page.picData, 'content': Page.picText }, function(d) { if (d.info) { $.alert(d.info, function() { $('.index .picture-mask').remove();
                                        Page.picData = []; }, 'error'); } }); } } });
            });
        });
        $(document.body).on('touchmove', function(evt) { evt.preventDefault() });
        $('.game-list').overscroll();
        ...
        if (win.version == '2.0.0') { var userIdCode = '<div class="user-id"><span>ID:' + (parseInt(user.id) + 100000) + '</span></div>';
        ...
        $('.niuniu-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.submit(); } });
        $('.niuniuSix-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.douniuSixSubmit(); } });
        $('.niuniuNine-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.douniuNineSubmit(); } });
        $('.niuniuTen-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.douniuTenSubmit(); } });
        $('.niuniuThirteen-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.douniuThirteenSubmit(); } });
        $('.goldflower-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.goldFlowerSubmit(); } });
        $('.thirteencard-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.thirteenCardSubmit(); } });
        $('.threeOpens-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.threeOpensSubmit(); } });
        $('.texas-poker-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.texasPokerSubmit(); } });
        $('.fillingPitcard-mask .createRoomBtn').on('click', function() { if (Page.time == 0) { Page.time = 2; var index = setInterval(function() { Page.time--; if (Page.time == 0) { clearInterval(index); } }, 1000);
                Page.fillingPitCardSubmit(); } });
        Page.douniuSwitch('.niuniu-mask');
        Page.douniuSixSwitch('.niuniuSix-mask');
        Page.douniuNineSwitch('.niuniuNine-mask');
        ...
        Page.fiveEndPoints(".niuniuSix-mask");
        Page.fiveEndPoints(".niuniuNine-mask");
        ...
        Page.prevNext(".niuniuSix-mask .prev", '.niuniuSix-mask .next', ".niuniuSix-mask ");
        Page.prevNext(".niuniuNine-mask .prev", '.niuniuNine-mask .next', ".niuniuNine-mask ");
    ...
    pic_upload: function(em, size, multiple) {
        ...
        if (multiple) { var fileInput = $('<input>').attr('type', 'file').attr('multiple', multiple).appendTo('body'); } else { var fileInput = $('<input>').attr('type', 'file').appendTo('body');
            fileInput.hide(); }
            ...
            if (this.files.length > 0) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    img.onload = function() {
                        ...
                        if ($('.picture-mask .container .pic')) { if ($('.picture-mask .container .pic').length == 3) { $('.picture-mask .container .upload').addClass('uploadColor');
                                $(em).off('click'); } }
                        ...
                        if (size[1] == 0) { cvs.attr('height', height);
                            context.drawImage(this, 0, 0, imgWidth, imgHeight, 0, 0, size[0], height); } else {
                            if (imgR > size[0] / size[1]) { var x = (size[0] - imgWidth * r) / 2; var y = 0; var h = size[1]; var w = h * imgR; } else { var x = 0; var y = (size[1] - imgHeight * r) / 2; var w = size[0]; var h = w / imgR; }
                            context.drawImage(this, x, y, w, h);
                        }
                        var data = cvs[0].toDataURL('image/jpeg');
                        data = data.replace('data:image/jpeg;base64,', '');
                        Page.picData.push(data);
                        $(img).css({ width: '.3936rem', height: '.3936rem' });
                        fileInput.remove();
                    };
                }
            }
    ...
    douniuGame: function() {
        $('.game-list .niuniu-bg button').one('click', function() {
            ...
            if (data) { $('.niuniu-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                ...
                $('.niuniu-mask [name="niuniu_zhuang_value"][value="' + data.zhuang_value + '"]').click(); var arr = data.hand_patterns.split(','); for (var i in arr) { $('.niuniu-mask [name="niuniu_hand_patterns"][value="' + parseInt(arr[i]) + '"]').click(); } }
            $('.niuniu-mask').show();
            $('.game-list .niuniu-bg button').on('click', function() { $('.niuniu-mask').show(); });
        });
        $('.niuniu-mask .content-box .close-window').click(function() { $('.niuniu-mask').hide(); });
    },
    submit: function() {
        ...
        var hand_patterns = [];
        $('.niuniu-mask [name="niuniu_hand_patterns"]').each(function() { if (this.checked) { hand_patterns.push(this.value); } });
        var max_matches = $('.niuniu-mask [name="niuniu_max_matches"]:checked').val();
        var data = { 'zhuang_type': zhuang_type, 'end_points': end_points, 'card_rule': card_rule, 'hand_patterns': hand_patterns.join(','), 'max_matches': max_matches, 'zhuang_value': zhuang_value };
        storage.set('roomrule_niuniu', data);
        ajax('home/gameDouniu/createRoom', data, function(d) {
            if (d.status == 1) { $('.niuniu-mask').hide(); if (USE_QRCODE) { var url = 'http://' + JUMP_DOMAIN + '/sixoxen.html?code=' + d.info.code;
                    qrcodeCreate(url, 1, generalQrcodeData(d.info)); if (parseInt(d.info.count_matchs) === 10) { $('.user-info .room-card span').text(Page.roomCard - 1);
                        ...
                        Page.roomCard = parseInt($('.user-info .room-card span').text()); } } else { location.href = 'sixoxen.html?code=' + d.info.code; } } else if (d.status == 2) {
                ...
                code += '</div>';
                $(code).appendTo('body');
                setTimeout(function() { $('.close-room').css('opacity', '1'); }, 100)
                $('<div class="close-room-mask">').appendTo('body');
                $('.close-room , .close-room-mask').click(function() { $('.close-room').hide();
    ...
    douniuTenGame: function() {
        $('.game-list .niuniuTen-bg  button').one('click', function() {
            ...
            if (data) { $('.niuniuTen-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                ...
                $('.niuniuTen-mask [name="niuniuTen_zhuang_value"][value="' + data.zhuang_value + '"]').click(); var arr = data.hand_patterns.split(','); for (var i in arr) { $('.niuniuTen-mask [name="niuniuTen_hand_patterns"][value="' + arr[i] + '"]').click(); } }
            $('.niuniuTen-mask').show();
            $('.game-list .niuniuTen-bg  button').on('click', function() { $('.niuniuTen-mask').show(); });
        });
        $('.niuniuTen-mask .content-box .close-window').click(function() { $('.niuniuTen-mask').hide(); });
    },
    douniuTenSubmit: function() { var zhuang_type = $('.niuniuTen-mask .tab span.tab-item.on').attr('data-item'); var end_points = $('.niuniuTen-mask .showNumber i').text(); var card_rule = $('.niuniuTen-mask [name="niuniuTen_card_rule"]:checked').val(); var zhuang_value = $('.niuniuTen-mask [name="niuniuTen_zhuang_value"]:checked').val(); var hand_patterns = [];
        ...
        ajax('nine9ye/create10NiuRoom', data, function(d) { if (d.status == 1) { $('.niuniuTen-mask').hide(); if (USE_QRCODE) { var url = 'http://' + JUMP_DOMAIN + '/tenniuniu?type=liuliu&room_code=' + d.info.code;
                    qrcodeCreate(url, 4, generalQrcodeData(d.info)); if (parseInt(d.info.count_matchs) === 12) { $('.user-info .room-card span').text(Page.roomCard - 2);
                        ...
                        Page.roomCard = parseInt($('.user-info .room-card span').text()); } } else { location.href = 'tenniuniu?type=liuliu&room_code=' + d.info.code; } } else if (d.status == 2) { $.alert('已有创建房间', 'error'); } else if (d.status == 3) { Page.phoneMask('.niuniuTen-mask'); } else { $.alert(d.info); } }); },
    douniuSwitch: function(className) {
        $(className + ' .tab span').touch(function() {
            var item = $(this).data('item');
            $(this).siblings(className + ' .tab-item').removeClass('on');
            $(this).addClass('on');
            if (item == 5) { var zhuang = '<div class="flex-cont ">';
                ...
                zhuang += '   </div>';
                zhuang += '</div>';
                $(className + ' .content > .zhuang').html(zhuang); } else { $(className + ' .content > .zhuang').empty(); }
            $(className + ' .radio >div').removeClass('on');
            if (item == 2) { var code = '<div class="prev2"></div>';
                ...
                Page.prevNext2(className + " .prev2", className + ' .next2', className); } else { var code = '<div class="prev"></div>';
                code += '<div class="radio flex-item">';
    ...
    douniuThirteenGame: function() {
        $('.game-list .thirteenoxen-bg ').one('click', function() {
            ...
            if (data) { $('.niuniuThirteen-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                ...
                $('.niuniuThirteen-mask [name="niuniuThirteen_zhuang_value"][value="' + data.zhuang_value + '"]').click(); var arr = data.hand_patterns.split(','); for (var i in arr) { $('.niuniuThirteen-mask [name="niuniuThirteen_hand_patterns"][value="' + arr[i] + '"]').click(); } }
            $('.niuniuThirteen-mask').show();
            $('.game-list .thirteenoxen-bg ').on('click', function() { $('.niuniuThirteen-mask').show(); });
        });
        $('.niuniuThirteen-mask .content-box .close-window').click(function() { $('.niuniuThirteen-mask').hide(); });
    },
    douniuThirteenSubmit: function() { var zhuang_type = $('.niuniuThirteen-mask .tab span.tab-item.on').attr('data-item'); var end_points = $('.niuniuThirteen-mask .showNumber i').text(); var card_rule = $('.niuniuThirteen-mask [name="niuniuThirteen_card_rule"]:checked').val(); var zhuang_value = $('.niuniuThirteen-mask [name="niuniuThirteen_zhuang_value"]:checked').val(); var hand_patterns = [];
        $('.niuniuThirteen-mask [name="niuniuThirteen_hand_patterns"]').each(function() { if (this.checked) { hand_patterns.push(this.value); } }); var max_matches = $('.niuniuThirteen-mask [name="niuniuThirteen_max_matches"]:checked').val(); var data = { 'zhuang_type': zhuang_type, 'end_points': end_points, 'card_rule': card_rule, 'hand_patterns': hand_patterns.join(','), 'max_matches': max_matches, 'zhuang_value': zhuang_value };
    ...
    douniuSixGame: function() {
        $('.game-list .niuniuSix-bg button').one('click', function() {
            var iCode = '<label><input type="checkbox" name="niuniuSix_hand_patterns" value="1" ><span>五花牛（5倍）</span></label>';
            iCode += '<label><input type="checkbox" name="niuniuSix_hand_patterns" value="2"><span>炸弹牛（6倍）</span></label>';
            iCode += '<label><input type="checkbox" name="niuniuSix_hand_patterns" value="3"><span>五小牛（8倍）</span></label>';
            $('.pupop-container.niuniuSix-mask .content > .flex-cont.type .flex-item').html(iCode);
            var data = storage.get('roomrule_niuniuSix');
            if (data) { $('.niuniuSix-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                $(".niuniuSix-mask .radio > div[data-item='" + data.end_points + "']").touch();
                $('.niuniuSix-mask [name="niuniuSix_card_rule"][value="' + data.card_rule + '"]').click();
                $('.niuniuSix-mask [name="niuniuSix_max_matches"][value="' + data.max_matches + '"]').click();
                $('.niuniuSix-mask [name="niuniuSix_zhuang_value"][value="' + data.zhuang_value + '"]').click(); var arr = data.hand_patterns.split(','); for (var i in arr) { $('.niuniuSix-mask [name="niuniuSix_hand_patterns"][value="' + parseInt(arr[i]) + '"]').click(); } }
            $('.niuniuSix-mask').show();
            $('.game-list .niuniuSix-bg button').on('click', function() { $('.niuniuSix-mask').show(); });
        });
        $('.niuniuSix-mask .content-box .close-window').click(function() { $('.niuniuSix-mask').hide(); });
    },
    douniuSixSubmit: function() {
        var zhuang_type = $('.niuniuSix-mask .tab span.tab-item.on').attr('data-item');
        var end_points = $('.niuniuSix-mask .showNumber i').text();
        var card_rule = $('.niuniuSix-mask [name="niuniuSix_card_rule"]:checked').val();
        var zhuang_value = $('.niuniuSix-mask [name="niuniuSix_zhuang_value"]:checked').val();
        var hand_patterns = [];
        $('.niuniuSix-mask [name="niuniuSix_hand_patterns"]').each(function() { if (this.checked) { hand_patterns.push(this.value); } });
        var max_matches = $('.niuniuSix-mask [name="niuniuSix_max_matches"]:checked').val();
        var data = { 'zhuang_type': zhuang_type, 'end_points': end_points, 'card_rule': card_rule, 'hand_patterns': hand_patterns.join(','), 'max_matches': max_matches, 'zhuang_value': zhuang_value };
        storage.set('roomrule_niuniuSix', data);
        ajax('home/gameDouniuSix/createRoom', data, function(d) {
            if (d.status == 1) { $('.niuniuSix-mask').hide(); if (USE_QRCODE) { var url = 'http://' + JUMP_DOMAIN + '/bull6.html?code=' + d.info.code;
                    qrcodeCreate(url, 8, generalQrcodeData(d.info)); if (parseInt(d.info.count_matchs) === 10) { $('.user-info .room-card span').text(Page.roomCard - 1);
                        Page.roomCard = parseInt($('.user-info .room-card span').text()); } else if (parseInt(d.info.count_matchs) === 20) { $('.user-info .room-card span').text(Page.roomCard - 2);
                        Page.roomCard = parseInt($('.user-info .room-card span').text()); } } else { location.href = 'bull6.html?code=' + d.info.code; } } else if (d.status == 2) {
                var code = '<div class="close-room">';
                code += '    <div class="close"></div>';
                code += '    <div class="close-room-text">';
                code += '    您的房间[ "' + d.info + '" ]尚未完结，无法创建新的房间！<br>是否结算该房间？';
    ...
    douniuNineGame: function() {
        $('.game-list .niuniuNine-bg  button').one('click', function() {
            var tCode = '<label><input type="checkbox" name="niuniuNine_hand_patterns" value="1" ><span>五花牛（5倍）</span></label>';
            tCode += '<label><input type="checkbox" name="niuniuNine_hand_patterns" value="2"><span>炸弹牛（6倍）</span></label>';
            tCode += '<label><input type="checkbox" name="niuniuNine_hand_patterns" value="3"><span>五小牛（8倍）</span></label>';
            $('.pupop-container.niuniuNine-mask .content > .flex-cont.type .flex-item').html(tCode);
            var data = storage.get('roomrule_niuniuNine');
            if (data) { $('.niuniuNine-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
                $(".niuniuNine-mask .radio > div[data-item='" + data.end_points + "']").touch();
                $('.niuniuNine-mask [name="niuniuNine_card_rule"][value="' + data.card_rule + '"]').click();
                $('.niuniuNine-mask [name="niuniuNine_max_matches"][value="' + data.max_matches + '"]').click();
                $('.niuniuNine-mask [name="niuniuNine_zhuang_value"][value="' + data.zhuang_value + '"]').click(); var arr = data.hand_patterns.split(','); for (var i in arr) { $('.niuniuNine-mask [name="niuniuNine_hand_patterns"][value="' + arr[i] + '"]').click(); } }
            $('.niuniuNine-mask').show();
            $('.game-list .niuniuNine-bg  button').on('click', function() { $('.niuniuNine-mask').show(); });
        });
        $('.niuniuNine-mask .content-box .close-window').click(function() { $('.niuniuNine-mask').hide(); });
    },
    douniuNineSubmit: function() { var zhuang_type = $('.niuniuNine-mask .tab span.tab-item.on').attr('data-item'); var end_points = $('.niuniuNine-mask .showNumber i').text(); var card_rule = $('.niuniuNine-mask [name="niuniuNine_card_rule"]:checked').val(); var zhuang_value = $('.niuniuNine-mask [name="niuniuNine_zhuang_value"]:checked').val(); var hand_patterns = [];
        $('.niuniuNine-mask [name="niuniuNine_hand_patterns"]').each(function() { if (this.checked) { hand_patterns.push(this.value); } }); var max_matches = $('.niuniuNine-mask [name="niuniuNine_max_matches"]:checked').val(); var data = { 'zhuang_type': zhuang_type, 'end_points': end_points, 'card_rule': card_rule, 'hand_patterns': hand_patterns.join(','), 'max_matches': max_matches, 'zhuang_value': zhuang_value };
        storage.set('roomrule_niuniuNine', data);
    ...
    douniuSixSwitch: function(className) {
        $(className + ' .tab span').touch(function() {
            ...
            if (item == 5) { var zhuang = '<div class="flex-cont ">';
                zhuang += '    <div class="name">上庄:</div>';
                zhuang += '    <div class="flex-item">';
                zhuang += '        <label><input type="radio" name="niuniuSix_zhuang_value" value="0"><span>无</span></label>';
                zhuang += '        <label><input type="radio" name="niuniuSix_zhuang_value" value="100"><span>100</span></label>';
                zhuang += '        <label><input type="radio" name="niuniuSix_zhuang_value" value="300"><span>300</span></label>';
                zhuang += '        <label><input type="radio" name="niuniuSix_zhuang_value" value="500" checked><span>500</span></label>';
                zhuang += '   </div>';
                zhuang += '</div>';
                $(className + ' .content > .zhuang').html(zhuang); } else { $(className + ' .content > .zhuang').empty(); }
            $(className + ' .radio >div').removeClass('on');
    ...
    douniuNineSwitch: function(className) {
        $(className + ' .tab span').touch(function() {
            var item = $(this).data('item');
            $(this).siblings(className + ' .tab-item').removeClass('on');
            $(this).addClass('on');
            if (item == 5) { var zhuang = '<div class="flex-cont ">';
                zhuang += '    <div class="name">上庄:</div>';
                zhuang += '    <div class="flex-item">';
                zhuang += '        <label><input type="radio" name="niuniuNine_zhuang_value" value="0"><span>无</span></label>';
                zhuang += '        <label><input type="radio" name="niuniuNine_zhuang_value" value="100"><span>100</span></label>';
                zhuang += '        <label><input type="radio" name="niuniuNine_zhuang_value" value="300"><span>300</span></label>';
                zhuang += '        <label><input type="radio" name="niuniuNine_zhuang_value" value="500" checked><span>500</span></label>';
                zhuang += '   </div>';
                zhuang += '</div>';
                $(className + ' .content > .zhuang').html(zhuang); } else { $(className + ' .content > .zhuang').empty(); }
            $(className + ' .radio >div').removeClass('on');
    ...
    goldFlowerGame: function() {
        $('.game-list .goldflower-bg  button').one('click', function() {
            var data = storage.get('roomrule_goldFlower');
            if (data) { $(".goldflower-mask .radio > div[data-item='" + data.flower_end_points + "']").touch();
            ...
            $('.game-list .goldflower-bg  button').on('click', function() { $('.goldflower-mask').show(); });
        });
        $('.goldflower-mask .content-box .close-window').click(function() { $('.goldflower-mask').hide(); });
    },
    goldFlowerSubmit: function() { var flower_end_points = $('.goldflower-mask .showNumber i').text(); var chip_rule = $('.goldflower-mask [name="gold_card_rule"]:checked').val(); var chip = $('.goldflower-mask [name="gold_hand_patterns"]:checked').val(); var max_matches = $('.goldflower-mask [name="gold_max_matches"]:checked').val(); var data = { 'flower_end_points': flower_end_points, 'chip_rule': chip_rule, 'upper_limit': chip, 'max_matches': max_matches };
    ...
    thirteenCardGame: function() {
        $('.game-list .thirteencard-bg  button').one('click', function() {
            ...
            if (data) { $(".thirteencard-mask .radio > div[data-item='" + data.end_points + "']").touch();
                $('.thirteencard-mask [name="thirteen_max_matches"][value="' + data.max_matches + '"]').click(); }
            $('.thirteencard-mask').show();
            $('.game-list .thirteencard-bg  button').on('click', function() { $('.thirteencard-mask').show(); });
        });
        $('.thirteencard-mask .content-box .close-window').click(function() { $('.thirteencard-mask').hide(); });
    },
    thirteenCardSubmit: function() { var zhuang_type = "1"; var end_points = $('.thirteencard-mask .showNumber i').text(); var hand_patterns = $('.thirteencard-mask [name="thirteen_hand_patterns"]:checked').val(); var max_matches = $('.thirteencard-mask [name="thirteen_max_matches"]:checked').val(); var data = { 'zhuang_type': zhuang_type, 'end_points': end_points, 'play_type': hand_patterns, 'max_matches': max_matches };
        storage.set('roomrule_thirteencard', data);
        ajax('home/gameThirteen/createRoom', data, function(d) { if (d.status == 1) { $('.thirteencard-mask').hide(); if (USE_QRCODE) { var url = 'http://' + JUMP_DOMAIN + '/thirteen.html?code=' + d.info.code;
    ...
    threeOpensGame: function() {
        $('.game-list .three-opens-bg button').one('click', function() {
            ...
            if (data) { $('.threeOpens-mask .tab span[data-item="' + data.zhuang_type + '"]').touch();
            ...
            $('.game-list .three-opens-bg  button').on('click', function() { $('.threeOpens-mask').show(); });
        });
        $('.threeOpens-mask .content-box .close-window').click(function() { $('.threeOpens-mask').hide(); });
    },
    threeOpensSubmit: function() { var zhuang_type = $('.threeOpens-mask .tab span.tab-item.on').attr('data-item'); var end_points = $('.threeOpens-mask .showNumber i').text(); var card_rule = [];
        $('.threeOpens-mask [name="threeOpens_hand_patterns"]').each(function() { if (this.checked) { card_rule.push(this.value); } }); var max_matches = $('.threeOpens-mask [name="threeOpens_max_matches"]:checked').val(); var data = { 'zhuang_type': zhuang_type, 'end_points': end_points, 'card_rule': card_rule.join(','), 'max_matches': max_matches };
    ...
    texasPokerGame: function() {
        $('.game-list .texas-poker-bg  button').one('click', function() {
            var data = storage.get('roomrule_texasPoker');
            if (data) { $('.texas-poker-mask [name="texasPoker_mang"][value="' + data.texas_end_points + '"]').click();
            ...
            $('.game-list .texas-poker-bg  button').on('click', function() { $('.texas-poker-mask').show(); });
        });
        $('.texas-poker-mask .content-box .close-window').click(function() { $('.texas-poker-mask').hide(); });
    },
    texasPokerSubmit: function() { var mang = $('.texas-poker-mask [name="texasPoker_mang"]:checked').val(); var innings = $('.texas-poker-mask [name="texasPoker_jushu"]:checked').val(); var zhu = $('.texas-poker-mask [name="texasPoker_zhu"]:checked').val(); var chip = $('.texas-poker-mask [name="texasPoker_chip"]:checked').val(); var data = { 'texas_end_points': mang, 'max_matches': innings, 'end_points_rule': zhu, 'init_points': chip };
    ...
    fillingPitCardGame: function() {
        $('.game-list .fillingPitcard-bg').one('click', function() {
            ...
            if (data) {
                ...
                if (data.sorce_type) { $('.fillingPitcard-mask [name="fillingPit_dogfall"][value="' + data.sorce_type + '"]').click(); }
                $('.fillingPitcard-mask [name="fillingPit_loves"][value="' + data.happy_points + '"]').click();
                if (data.play_type) { var arr = data.play_type.split(','); for (var i in arr) { $('.fillingPitcard-mask [name="fillingPit_others"]').each(function(index) { if ($(this).attr('value') == arr[i]) { $(this).addClass('withGodChecked'); } }); } }
                $('.fillingPitcard-mask [name="fillingPit_max_matches"][value="' + data.max_matches + '"]').click();
            }
            $('.fillingPitcard-mask').show();
            $('.game-list .fillingPitcard-bg').on('click', function() { $('.fillingPitcard-mask').show(); });
            $('.fillingPit_others_one').on('click', function(e) { $('.withGod').toggleClass('withGodChecked'); if (!$('.withGod').hasClass("withGodChecked")) { if ($('.withGodBoom').hasClass("withGodChecked")) { $('.withGodBoom').removeClass('withGodChecked'); } } });
            $('.fillingPit_others_two').on('click', function(e) { $('.withGodBoom').toggleClass('withGodChecked'); if ($('.withGodBoom').hasClass("withGodChecked")) { if (!$('.withGod').hasClass("withGodChecked")) { $('.withGod').addClass('withGodChecked'); } } });
        });
        $('.fillingPitcard-mask .content-box .close-window').click(function() { $('.fillingPitcard-mask').hide(); });
    },
    fillingPitCardSubmit: function() {
        ...
        if ($('.fillingPitcard-mask [name="fillingPit_dogfall"]:checked').length > 0) { var sorce_type = parseInt($('.fillingPitcard-mask [name="fillingPit_dogfall"]:checked').val()); }
        var happy_points = $('.fillingPitcard-mask [name="fillingPit_loves"]:checked').val();
        if ($('.fillingPitcard-mask [name="fillingPit_others"].withGodChecked').length > 0) { var play_type = '';
            $('.fillingPitcard-mask [name="fillingPit_others"]').each(function(index) { if (index == 0 && $(this).hasClass("withGodChecked")) { play_type += $(this).attr('value'); } else if ($(this).hasClass("withGodChecked")) { play_type += ',' + $(this).attr('value'); } }); }
        var max_matches = $('.fillingPitcard-mask [name="fillingPit_max_matches"]:checked').val();
        var data = { 'end_points': end_points, 'games_mode': games_mode };
        if ($('.fillingPitcard-mask [name="fillingPit_dogfall"]:checked').length > 0) { data.sorce_type = sorce_type; }
        data.happy_points = happy_points;
        if ($('.fillingPitcard-mask [name="fillingPit_others"].withGodChecked').length > 0) { data.play_type = play_type; }
    ...
    phoneMask: function(className) { $(className).hide(); var code = '<div class="phone-number-box">';
        ...
        code += '</div>';
        $(code).appendTo('.index'); },
    prevNext: function(prev, next, className) { $(next).touch(function() { var len = parseInt($(className + " .radio > div").length); var i = parseInt($(className + " .radio > div.on").data('pos'));
            i++; if (i > len) return;
            $(className + " .radio > div").removeClass('on'); var num = $(className + " .radio > div").eq(i - 1).addClass('on').attr('data-item');
            $(className + ' .showNumber').attr("data-pos", i);
            $(className + ' .showNumber i').text(num); });
        $(prev).touch(function() { var len = parseInt($(className + " .radio > div").length); var i = parseInt($(className + " .radio > div.on").data('pos'));
            i--; if (i < 1) return;
            $(className + " .radio > div").removeClass('on'); var num = $(className + " .radio > div").eq(i - 1).addClass('on').attr('data-item');
            $(className + ' .showNumber').attr("data-pos", i);
            $(className + ' .showNumber i').text(num); }); },
    fiveEndPoints: function(className) { $(className + " .radio > div").touch(function() { var n = $(this).attr('data-pos'); var num = $(this).attr('data-item');
            $(className + " .radio > div").removeClass('on');
            $(this).addClass('on');
            $(className + ' .showNumber').attr("data-pos", n);
            $(className + ' .showNumber i').text(num); }); },
    prevNext2: function(prev, next, className) { $(next).touch(function() { var len = parseInt($(className + " .radio > div").length); var i = parseInt($(className + " .radio > div.on").data('pos'));
            i++; if (i > len) return;
            $(className + " .radio > div").removeClass('on'); var num = $(className + " .radio > div[data-pos='" + i + "']").addClass('on').attr('data-item');
        ...
        $(prev).touch(function() { var len = parseInt($(className + " .radio > div").length); var i = parseInt($(className + " .radio > div.on").data('pos'));
            ...
            $(className + ' .showNumber').attr("data-item", num);
            $(className + ' .showNumber i').text(num); }); },
    threeEndPoints: function(className) { $(className + " .radio > div").touch(function() { var num = $(this).attr('data-item');
            $(className + " .radio > div").removeClass('on');
            $(this).addClass('on');
            $(className + ' .showNumber').attr("data-item", num);
            $(className + ' .showNumber i').text(num); }); }
